...
| `apiProxy.targets.openai.authHeader` | `--openai-api-auth-header` (frontmatter: `sandbox.agent.apiProxy.targets.openai.authHeader`) |
| `apiProxy.targets.anthropic.authHeader` | `--anthropic-api-auth-header` (frontmatter: `sandbox.agent.apiProxy.targets.anthropic.authHeader`) |
