...
| `apiProxy.targets.openai.authHeader` | `--openai-api-auth-header` (frontmatter: `awf.apiProxy.targets.openai.authHeader`) |
| `apiProxy.targets.anthropic.authHeader` | `--anthropic-api-auth-header` (frontmatter: `awf.apiProxy.targets.anthropic.authHeader`) |
