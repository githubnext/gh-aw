...
| `rl-004-concurrent-conflict.yaml` | Concurrent label-conflict handling: fail-closed on HTTP errors, no auto-retry after success | RL-041–RL-044, T-RL-041–T-RL-044 |
