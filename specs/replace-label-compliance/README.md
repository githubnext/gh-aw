...
| `rl-002-allowlist-enforcement.yaml` | Non-empty allowlists enforce matches while empty allowlists permit any non-blocked label | RL-002, T-RL-021, T-RL-022, T-RL-025 |
...
| T-RL-022 | `rl-002-allowlist-enforcement.yaml` | Non-empty allowed-add rejects a non-matching label |
