...
| `rl-004-concurrent-conflict.yaml` | Concurrent label-conflict handling: fail-closed on HTTP errors, no auto-retry after success | RL-057–RL-060, T-RL-057–T-RL-060 |
