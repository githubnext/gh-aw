...
|--------------|------------------------------|-------------------------------|
| `1.0.22` | `v0.83.6` (or newer) | Adds conformance coverage for the existing optimizer suppression and failure-safeguard norms; no lock-file compatibility changes. |
