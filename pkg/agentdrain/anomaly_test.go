...
type anomalyAnalyzeTestCase struct {
	name              string
...
var anomalyAnalyzeTestCases = []anomalyAnalyzeTestCase{
	{
...
func TestAnomalyDetector_Analyze(t *testing.T) {
	for _, tt := range anomalyAnalyzeTestCases {
		t.Run(tt.name, func(t *testing.T) {
			runAnalyzeAnomalyCase(t, tt)
		})
	}
}

func runAnalyzeAnomalyCase(t *testing.T, tt anomalyAnalyzeTestCase) {
	t.Helper()
...
type buildReasonTestCase struct {
	name          string
	isNewTemplate bool
	lowSimilarity bool
	rareCluster   bool
...
var buildReasonTestCases = []buildReasonTestCase{
	{
		name:          "no flags set",
		isNewTemplate: false,
		lowSimilarity: false,
...
func TestBuildReason(t *testing.T) {
	for _, tt := range buildReasonTestCases {
		t.Run(tt.name, func(t *testing.T) {
			assertBuildReasonCase(t, tt)
		})
	}
}

func assertBuildReasonCase(t *testing.T, tt buildReasonTestCase) {
	t.Helper()
