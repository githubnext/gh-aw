...
type singleJSONResponseLog struct {
	Response string         `json:"response"`
	Stats    map[string]any `json:"stats"`
}

func parseSingleJSONResponseLogMetrics(logContent string, verbose bool, engineName string, log *logger.Logger) LogMetrics {
	...
	for line := range lines {
		...
		var response singleJSONResponseLog
