...
func (c *Compiler) buildSafeOutputsJobs(data *WorkflowData, jobName, markdownPath string) error {
	...
	// Note: create-commit-status safe output uses pending/final status lifecycle
	// Pending status is created in activation job, final status in conclusion job
	// No separate safe-output job is needed
