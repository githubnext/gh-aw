...
type UniversalCLIEngineExecutionConfig struct {
	...
	// (for example, a shared engine id).
	...
	// StepName is the GitHub Actions step name (for example, an execution step name).
	StepName string
	...
	// selection (for example, an engine model variable). When empty, model selection
