...
func TestOutputLabelConfigMaxCountParsing(t *testing.T) {
	...
	// Test case with add-issue-labels configuration including max
	testContent := `---
on:
  issues:
    types: [opened]
...
func TestOutputLabelConfigDefaultMaxCount(t *testing.T) {
	...
	// Test case with add-issue-labels configuration without max (should use default)
	testContent := `---
on:
  issues:
    types: [opened]
...
func TestOutputLabelJobGenerationWithDefaultMaxCount(t *testing.T) {
	...
	// Test case with add-issue-labels configuration without max (should use default of 3)
	testContent := `---
on:
  issues:
    types: [opened]
