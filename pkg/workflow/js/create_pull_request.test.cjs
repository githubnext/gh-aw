...
describe("create_pull_request.cjs", () => {
  ...
  (beforeEach(() => {
    ...
    it("should handle labels correctly", async () => {
      ...
      (mockDependencies.github.rest.pulls.create.mockResolvedValue({ data: { number: 456, html_url: "https://github.com/testowner/testrepo/pull/456" } }), mockDependencies.github.rest.issues.addLabels.mockResolvedValue({}));
      const mainFunction = createMainFunction(mockDependencies);
      (await mainFunction(),
