...
// Create context validator for issues
const isIssueContext = createContextValidator({
  eventNames: ["issues", "issue_comment"],
});

// Create number extractor for issues
const getIssueNumber = createNumberExtractor({
