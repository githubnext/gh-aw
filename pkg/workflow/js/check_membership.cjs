...
async function main() {
  ...
  if (!requiredPermissions || requiredPermissions.length === 0) {
    core.warning("❌ Configuration error: Required permissions not specified. See https://githubnext.com/gh-aw/reference/frontmatter/#repository-access-roles-roles for how to update allowed roles.");
