...
async function main() {
  ...
  if (!isEmpty) {
    ...
    try {
      ...
      // Add "AI generated" footer to commit message body
      ...
      // Insert the AI footer before the "---" separator that marks the end of commit message
      // The patch format is:
      // Subject: [PATCH] Title
      // <blank line>
      // Commit body
      ...
      core.info(`Patch modified with AI generated footer: "${aiFooter}"`);
