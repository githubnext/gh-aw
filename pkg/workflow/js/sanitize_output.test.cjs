...
describe('sanitize_output.cjs', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.GITHUB_AW_SAFE_OUTPUT;
...
\tTab at start`;
  ...
  describe('main function', () => {
    ...
    it('should handle missing GITHUB_AW_SAFE_OUTPUT environment variable', async () => {
      delete process.env.GITHUB_AW_SAFE_OUTPUT;
      ...
      expect(consoleSpy).toHaveBeenCalledWith('GITHUB_AW_SAFE_OUTPUT not set, no output to collect');
    ...
    it('should handle non-existent output file', async () => {
      process.env.GITHUB_AW_SAFE_OUTPUT = '/tmp/non-existent-file.txt';
    ...
    it('should handle empty output file', async () => {
      ...
      process.env.GITHUB_AW_SAFE_OUTPUT = testFile;
