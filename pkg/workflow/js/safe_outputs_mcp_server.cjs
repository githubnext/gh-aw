...
const ALL_TOOLS = [
  ...
  },
  {
    ...
    description: "Trigger a workflow dispatch for allowed workflows. Requires actions: write permission.",
    inputSchema: {
      type: "object",
      required: ["workflow"],
      properties: {
        workflow: {
          type: "string",
          description: "Workflow filename to trigger (e.g., 'build.yml'). Must be in the allowed list.",
        },
        payload: {
          type: "string",
