...
const ALL_TOOLS = [
  ...
  {
    name: "close_issue",
    description: "Close a GitHub issue with optional outcome and reason",
    inputSchema: {
      type: "object",
      properties: {
        issue_number: {
        ...
        outcome: {
          ...
          description: "Optional close outcome: 'completed' (issue was resolved) or 'not_planned' (issue won't be worked on)",
        },
        reason: {
          type: "string",
          description: "Optional reason for closing (for logging/documentation purposes)",
        },
      },
      additionalProperties: false,
    },
