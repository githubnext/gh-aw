...
describe("close_issue", () => {
  ...
  it("should close issue with comment in triggering context", async () => {
    setAgentOutput({
      items: [
        {
          type: "close_issue",
          body: "Closing this issue due to completion.",
        },
      ],
    });
  ...
  it("should close specific issue when target is *", async () => {
    ...
    mockGithub.rest.issues.get.mockResolvedValue({
      data: {
        number: 100,
        title: "[refactor] Refactor Test",
        labels: [{ name: "refactoring" }],
        state: "open",
      ...
      items: [
        {
          type: "close_issue",
          issue_number: 91,
          body: "Closing issue 91.",
        },
        {
          type: "close_issue",
          issue_number: 92,
          body: "Closing issue 92.",
        },
      ],
    });
