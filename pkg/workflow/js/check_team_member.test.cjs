...
const mockCore = {
  ...
  mockContext = { actor: "testuser", repo: { owner: "testowner", repo: "testrepo" } };
((global.core = mockCore),
  ...
  describe("check_team_member.cjs", () => {
    ...
    (beforeEach(() => {
      (vi.clearAllMocks(), (global.context.actor = "testuser"), (global.context.repo = { owner: "testowner", repo: "testrepo" }));
