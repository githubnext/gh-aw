    ...
    (beforeEach(() => {
      ...
      it("should create discussions successfully with basic configuration", async () => {
        (mockGithub.graphql.mockResolvedValueOnce({
          ...
          repository: { id: "MDEwOlJlcG9zaXRvcnkxMjM0NTY3ODk=", discussionCategories: { nodes: [{ id: "DIC_test456", name: "General", slug: "general" }] } },
        }),
          mockGithub.graphql.mockResolvedValueOnce({
            // Create discussion mutation response
            createDiscussion: { discussion: { id: "D_test789", number: 1, title: "Test Discussion", url: "https://github.com/testowner/testrepo/discussions/1" } },
          }));
