...
func hasSharedGhAwImport(importedFiles []string) bool {
...
func generateGhAwExtensionInstallStep(yaml *strings.Builder) {
...
func (c *Compiler) generateSafeOutputsMCPSetup(yaml *strings.Builder, workflowData *WorkflowData, safeOutputConfig string) error {
...
func (c *Compiler) generateMCPScriptsMCPSetup(yaml *strings.Builder, workflowData *WorkflowData) error {
...
func (c *Compiler) generateMCPGatewaySetup(yaml *strings.Builder, tools map[string]any, engine CodingAgentEngine, workflowData *WorkflowData, mcpTools []string, hasAgenticWorkflows bool) error {
