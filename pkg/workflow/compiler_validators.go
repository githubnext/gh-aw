...
func (c *Compiler) emitExperimentalFeatureWarnings(workflowData *WorkflowData) {
	warnings := []struct {
		...
		{enabled: workflowData.EngineConfig != nil && workflowData.EngineConfig.ID == string(constants.ClaudeEngine) && workflowData.EngineConfig.LLMProvider == LLMProviderGitHub, message: "Using experimental feature: engine.model-provider: github (claude)"},
	}
