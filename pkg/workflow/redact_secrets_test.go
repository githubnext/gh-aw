...
`
	...
	// Verify do-not-edit notice is the FIRST line and gh-aw-metadata is second
	if len(lines) < 2 {
		t.Fatal("Lock file has fewer than 2 lines")
	}
	if lines[0] != "# This file was auto-generated by \"gh aw compile\" from https://github.com/github/gh-aw. Do not edit directly." {
		t.Errorf("Expected first line to be do-not-edit notice, got: %q", lines[0])
	}
	if !strings.HasPrefix(lines[1], "# gh-aw-metadata:") {
		t.Errorf("Expected second line to be '# gh-aw-metadata: ...', got: %q", lines[1])
	}
	...
	// Verify ordering: do-not-edit notice first, then metadata, then logo/disclaimer, then secrets/actions, then workflow body
	doNotEditPos := strings.Index(lockStr, "# This file was auto-generated by")
	...
	if doNotEditPos > metadataPos {
		t.Error("do-not-edit notice should appear before gh-aw-metadata")
	}
