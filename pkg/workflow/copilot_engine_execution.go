...
func buildEngineCommandScriptSetup(command string) string {
	...
	var delimiterBuilder strings.Builder
	delimiterBuilder.WriteString("GH_AW_ENGINE_COMMAND_EOF")
	for strings.Contains(scriptContent, delimiterBuilder.String()) {
		delimiterBuilder.WriteString("_X")
	}
	heredocDelimiter := delimiterBuilder.String()
