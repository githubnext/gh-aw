...
func (c *Compiler) generateWorkflowHeader(yaml *strings.Builder, data *WorkflowData, frontmatterHash string, bodyHash string, secrets []string, actions []string) {
	...
	// Add a human- and agent-readable do-not-edit notice as the very first line.
	yaml.WriteString("# This file was auto-generated by \"gh aw compile\" from https://github.com/github/gh-aw. Do not edit directly.\n")

	// Add lock metadata immediately after for easy machine parsing.
