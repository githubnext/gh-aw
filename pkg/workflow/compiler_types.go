...
// SkipIfCheckFailedConfig holds the configuration for skip-if-check-failed conditions
type SkipIfCheckFailedConfig struct {
...
type WorkflowData struct {
	...
	SkipIfCheckFailed           *SkipIfCheckFailedConfig // skip-if-check-failed configuration
