...
type WorkflowData struct {
	...
	ModelMappings                 map[string][]string             // merged model alias map (builtins + imported workflow aliases + main frontmatter overrides, in priority order); included in AWF config JSON
}
