...
type AgentSandboxConfig struct {
	...
	DefaultAiCreditsPricing *AiCreditsPricingConfig               `yaml:"default-ai-credits-pricing,omitempty"` // Fallback per-token pricing for models not in the built-in pricing table (optional)
