...
type AgentSandboxConfig struct {
	...
	LegacySecurity        bool                                  `yaml:"-"`                        // Deprecated: True when legacy-security: enable was set in frontmatter. Enables sudo, host-access, and iptables-based mode. Will be removed in a future version.
