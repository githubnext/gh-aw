...
// # Built-in Engines
//
// NewEngineCatalog registers the built-in engines: claude, codex, copilot, gemini, opencode, cursor, pi, antigravity.
...
// pre-registers the built-in engine definitions (claude, codex, copilot, gemini, opencode, cursor, pi, antigravity)
