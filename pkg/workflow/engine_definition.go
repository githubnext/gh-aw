...
// # Built-in Engines
//
// NewEngineCatalog registers the built-in engines: claude, codex, copilot, gemini, antigravity, pi.
...
// pre-registers the built-in engine definitions (claude, codex, copilot, gemini, antigravity, pi)
