...
// # Built-in Engines
//
// NewEngineCatalog registers the built-in engines: antigravity, claude, codex, copilot, crush, gemini, opencode, pi.
...
// pre-registers the built-in engine definitions (antigravity, claude, codex, copilot, crush, gemini, opencode, pi)
