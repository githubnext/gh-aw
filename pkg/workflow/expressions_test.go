...
func TestBuildReactionCondition(t *testing.T) {
	...
	if !strings.Contains(rendered, "(github.event_name == 'pull_request') && (github.event.pull_request.head.repo.id == github.event.repository.id)") {
...
func TestBuildNotFromFork(t *testing.T) {
	...
	expected := "github.event.pull_request.head.repo.id == github.event.repository.id"
