...
// For pull_request_target workflows, the step is always suppressed regardless of checkout
// configuration: checkout_pr_branch.cjs fetches refs/pull/<n>/head (the untrusted PR head),
