...
`
	...
	if !strings.Contains(yamlStr, `"entrypointArgs": ["-c", "bash ${RUNNER_TEMP}/gh-aw/safeoutputs/configure_git_credentials.sh && exec node ${RUNNER_TEMP}/gh-aw/safeoutputs/safe_outputs_mcp_server.cjs"]`) {
