...
func TestCreateIssueJobWithCopilotAssignee(t *testing.T) {
	...
	if !strings.Contains(assigneeStepContent, "GH_TOKEN: ${{ secrets.COPILOT_GITHUB_TOKEN || secrets.COPILOT_CLI_TOKEN || secrets.GH_AW_COPILOT_TOKEN || secrets.GH_AW_AGENT_TOKEN || secrets.GH_AW_GITHUB_TOKEN }}") {
