...
func buildPullRequestHandlerRegistry() map[string]handlerBuilder { //nolint:largefunc // Declarative handler registry.
	return map[string]handlerBuilder{
		...
		"create_pull_request": func(cfg *SafeOutputsConfig) map[string]any { //nolint:largefunc // Existing handler configuration is intentionally kept together.
