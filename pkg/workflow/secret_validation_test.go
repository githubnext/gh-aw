...
func TestGenerateMultiSecretValidationStep(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantStrings: []string{
				...
				"run: ${{ runner.temp }}/gh-aw/actions/validate_multi_secret.sh CODEX_API_KEY OPENAI_API_KEY Codex https://github.github.com/gh-aw/reference/engines/#openai-codex",
		...
		},
		{
			...
			wantStrings: []string{
				...
				"run: ${{ runner.temp }}/gh-aw/actions/validate_multi_secret.sh COPILOT_GITHUB_TOKEN 'GitHub Copilot CLI' https://github.github.com/gh-aw/reference/engines/#github-copilot-default",
		...
		},
		{
			...
			wantStrings: []string{
				...
				"run: ${{ runner.temp }}/gh-aw/actions/validate_multi_secret.sh ANTHROPIC_API_KEY 'Claude Code' https://github.github.com/gh-aw/reference/engines/#anthropic-claude-code",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !strings.Contains(stepContent, "${{ runner.temp }}/gh-aw/actions/validate_multi_secret.sh") {
