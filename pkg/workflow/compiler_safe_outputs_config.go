...
// Handler groups are registered in separate init() functions in:
//   - compiler_safe_outputs_handlers_issue.go    — issue, comment, discussion, label handlers
//   - compiler_safe_outputs_handlers_pr.go        — pull request handlers
//   - compiler_safe_outputs_handlers_dispatch.go  — dispatch and workflow handlers
//   - compiler_safe_outputs_handlers_misc.go      — utility and project handlers
var handlerRegistry = make(map[string]handlerBuilder)
