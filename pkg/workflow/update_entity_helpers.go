...
//
// Domain-specific configuration types and parsers are co-located here,
// mirroring how close_entity_helpers.go bundles all close variants:
...
//   - update_release.go — UpdateReleaseConfig, parseUpdateReleaseConfig (separate: larger scope)
//
