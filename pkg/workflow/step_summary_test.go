		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectModel == "" {
				...
				if !strings.Contains(lockContent, "GH_AW_INFO_MODEL: ${{ vars.GH_AW_MODEL_AGENT_COPILOT || vars.GH_AW_DEFAULT_MODEL_COPILOT || '"+constants.CopilotBYOKDefaultModel+"' }}") &&
					...
					!strings.Contains(lockContent, "GH_AW_INFO_MODEL: ${{ vars.GH_AW_MODEL_DETECTION_COPILOT || vars.GH_AW_MODEL_AGENT_COPILOT || vars.GH_AW_DEFAULT_MODEL_COPILOT || '"+constants.CopilotBYOKDefaultModel+"' }}") &&
