...
func TestBuiltinModelAliases(t *testing.T) {
	...
	assert.Equal(t, []string{"sonnet-6x", "gpt-5.4", "gpt-5.3", "gemini-pro", "any"}, aliases["agent"], "agent should default to <=6x-capable model families before any-model fallback")
