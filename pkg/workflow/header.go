...
func GenerateWorkflowHeader(sourceFile string, generatedBy string, customInstructions string) string {
	...
	if generatedBy != "" {
		if IsReleasedVersion(compilerVersion) {
			header.WriteString(fmt.Sprintf("# This file was automatically generated by %s (%s). DO NOT EDIT.\n", generatedBy, compilerVersion))
		} else {
			header.WriteString(fmt.Sprintf("# This file was automatically generated by %s. DO NOT EDIT.\n", generatedBy))
		}
	} else {
	...
	if sourceFile != "" {
		header.WriteString(fmt.Sprintf("# To update this file, edit %s and run:\n", sourceFile))
	} else {
		header.WriteString("# To regenerate this workflow, run:\n")
	}
	header.WriteString("#   " + constants.CLIExtensionPrefix + " compile\n")
