...
func TestEngineCatalog_IDs(t *testing.T) {
	...
	expectedIDs := []string{"antigravity", "claude", "codex", "copilot", "crush", "gemini", "opencode", "pi", "pydantic"}
...
func TestEngineCatalog_BuiltInsPresent(t *testing.T) {
	...
	expected := []string{"claude", "codex", "copilot", "gemini", "opencode", "crush", "pi", "pydantic"}
