...
func TestEngineCatalog_IDs(t *testing.T) {
	...
	expectedIDs := []string{"antigravity", "auggie", "claude", "codex", "copilot", "crush", "gemini", "opencode", "pi"}
...
func TestEngineCatalog_BuiltInsPresent(t *testing.T) {
	...
	expected := []string{"claude", "codex", "copilot", "gemini", "opencode", "crush", "pi", "auggie"}
