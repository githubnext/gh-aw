...
---`,
			expectedInLock: []string{
				...
				"path: /tmp/cache-memory-default",
				"- name: Upload cache-memory data as artifact",
				"name: cache-memory",
				"## Cache Folder Available",
				"You have access to a persistent cache folder at `/tmp/cache-memory-default/`",
			},
			notExpectedInLock: []string{
...
---`,
			expectedInLock: []string{
				...
				"mkdir -p /tmp/cache-memory-default",
				...
				"mkdir -p /tmp/cache-memory-session",
				...
				"## Cache Folders Available",
				"- **default**: `/tmp/cache-memory-default/`",
