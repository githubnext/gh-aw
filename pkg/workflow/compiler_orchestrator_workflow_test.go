...
func TestBuildInitialWorkflowData_BasicFields(t *testing.T) {
	...
	frontmatterResult := &parser.FrontmatterResult{
		Frontmatter:      map[string]any{"description": "Test workflow", "documentation": "https://docs.example.com/test-workflow", "source": "test-source"},
		FrontmatterLines: []string{"description: Test workflow", "documentation: https://docs.example.com/test-workflow", "source: test-source"},
		Markdown:         "# Test\n\nContent",
	}
	...
	assert.Equal(t, "https://docs.example.com/test-workflow", workflowData.Documentation)
