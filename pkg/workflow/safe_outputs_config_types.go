...
type BaseSafeOutputConfig struct {
	...
	IssueIntent              *bool            `yaml:"issue-intent,omitempty"`               // When false, disable issue-intent rationale/confidence guidance and schema requirements for this output type.
