...
type SafeOutputsConfig struct {
	...
	Data                                   any                                    `yaml:"data,omitempty"`                         // Structured data mode for body-based safe outputs: false/omitted (disabled), true (allow any object), object (inline schema), or string (schema file path)
	DataSchema                             any                                    `yaml:"data-schema,omitempty"`                  // Optional JSON schema (inline) used to validate `data` payloads for body-based safe outputs
	DataSchemaFile                         string                                 `yaml:"data-schema-file,omitempty"`             // Optional path to a JSON schema file used to validate `data` payloads for body-based safe outputs
	DataEnabled                            bool                                   `yaml:"-"`                                      // Internal flag controlling whether `data` is allowed for body-based safe outputs
	NormalizedDataSchema                   map[string]any                         `yaml:"-"`                                      // Internal normalized schema derived from DataSchema/DataSchemaFile
