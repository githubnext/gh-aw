...
func (c *Compiler) generatePRContextPromptStep(yaml *strings.Builder, data *WorkflowData) {
	...
	yaml.WriteString("        if: |\n")
	yaml.WriteString("          (\n")
	yaml.WriteString("            github.event_name == 'issue_comment' &&\n")
	yaml.WriteString("            github.event.issue.pull_request != null\n")
	yaml.WriteString("          ) || (\n")
	yaml.WriteString("            github.event_name == 'pull_request_review_comment'\n")
	yaml.WriteString("          ) || (\n")
	yaml.WriteString("            github.event_name == 'pull_request_review'\n")
	yaml.WriteString("          )\n")
	yaml.WriteString("        env:\n")
	yaml.WriteString("          GITHUB_AW_PROMPT: /tmp/aw-prompts/prompt.txt\n")
	yaml.WriteString("        run: |\n")
