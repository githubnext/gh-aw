...
`
	...
	assert.Contains(t, lockContent, "microsoft/apm-setup",
		"Lock file should reference the microsoft/apm-setup action")
...
`
	...
	assert.NotContains(t, lockContent, "microsoft/apm-setup",
		"Lock file should not reference microsoft/apm-setup when no dependencies specified")
}
