...
`
	...
	// For Copilot engine, MCP config is in --additional-mcp-config argument (quoted JSON, not base64)
...
`
	...
	// For Copilot, JSON is directly in the command (quoted), not base64-encoded
