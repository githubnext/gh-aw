...
// disk the same way the agent job does. The safe_outputs-specific differences are:
...
func (c *Compiler) buildSharedPRCheckoutSteps(data *WorkflowData) []string {
	...
	// Default workspace checkout (same generator as the agent job; root-only sparse by
	// default, see the function doc comment).
