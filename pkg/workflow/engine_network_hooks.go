...
// Taken from https://github.com/github/ebpf-padawan-egress-firewall/tree/main/docs/rules/default_padawan
func getDefaultAllowedDomains() []string {
	return []string{
		...
		// Google Cloud Storage (used by various package managers)
