...
// to ${{ runner.temp }}/gh-aw/actions/ as a flat directory structure. Any require() statements
...
func TestCJSFilesNoActionsRequires(t *testing.T) {
	...
	if len(failedFiles) > 0 {
		...
		t.Error("to ${{ runner.temp }}/gh-aw/actions/ as a flat directory. Any require() statements that")
