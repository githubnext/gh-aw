...
func validateSafeOutputsTarget(config *SafeOutputsConfig) error {
	...
	configs := collectSafeOutputTargetConfigs(config)
...
func collectSafeOutputTargetConfigs(config *SafeOutputsConfig) []safeOutputTargetConfig {
	var configs []safeOutputTargetConfig
	configs = appendIssueSafeOutputTargetConfigs(configs, config)
	configs = appendReviewSafeOutputTargetConfigs(configs, config)
	return configs
}

func appendIssueSafeOutputTargetConfigs(configs []safeOutputTargetConfig, config *SafeOutputsConfig) []safeOutputTargetConfig {
...
func appendReviewSafeOutputTargetConfigs(configs []safeOutputTargetConfig, config *SafeOutputsConfig) []safeOutputTargetConfig {
