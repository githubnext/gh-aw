...
`
	...
	if !strings.Contains(lockYAML, "uses: actions/upload-artifact@bbbca2ddaa5d8feaa63e36b76fdaad77386f024f") {
		t.Error("Expected 'actions/upload-artifact@bbbca2ddaa5d8feaa63e36b76fdaad77386f024f' action to be used")
	}
