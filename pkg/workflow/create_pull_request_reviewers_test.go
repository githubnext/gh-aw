...
// TestCreatePullRequestJobWithReviewers tests workflow functionality
...
// TestCreatePullRequestJobWithoutReviewers tests workflow functionality
// SKIPPED: Scripts are now loaded from external files at runtime using require() pattern
func TestCreatePullRequestJobWithoutReviewers(t *testing.T) {
t.Skip("Workflow tests skipped - scripts now use require() pattern to load external files at runtime")
}

// TestCreatePullRequestJobWithSingleReviewer tests workflow functionality
// SKIPPED: Scripts are now loaded from external files at runtime using require() pattern
func TestCreatePullRequestJobWithSingleReviewer(t *testing.T) {
t.Skip("Workflow tests skipped - scripts now use require() pattern to load external files at runtime")
}

// TestParsePullRequestsConfigWithReviewers tests workflow functionality
// SKIPPED: Scripts are now loaded from external files at runtime using require() pattern
func TestParsePullRequestsConfigWithReviewers(t *testing.T) {
t.Skip("Workflow tests skipped - scripts now use require() pattern to load external files at runtime")
}

// TestParsePullRequestsConfigWithSingleStringReviewer tests workflow functionality
// SKIPPED: Scripts are now loaded from external files at runtime using require() pattern
func TestParsePullRequestsConfigWithSingleStringReviewer(t *testing.T) {
t.Skip("Workflow tests skipped - scripts now use require() pattern to load external files at runtime")
}

// TestCreatePullRequestJobWithCopilotReviewer tests workflow functionality
// SKIPPED: Scripts are now loaded from external files at runtime using require() pattern
func TestCreatePullRequestJobWithCopilotReviewer(t *testing.T) {
t.Skip("Workflow tests skipped - scripts now use require() pattern to load external files at runtime")
}

// TestCreatePullRequestJobWithCustomGitHubToken tests workflow functionality
// SKIPPED: Scripts are now loaded from external files at runtime using require() pattern
