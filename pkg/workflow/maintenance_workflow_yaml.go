          ...
          script: |
            ...
            const body = [
              ...
              ...(zeroProjectedWithSamples > 0 ? [
                '> [!TIP]',
                '> ' + zeroProjectedWithSamples + ' workflow(s) have sampled runs but forecast ET is 0. This usually indicates missing token usage in cached run summaries for sampled runs.',
