...
func TestEngineCatalog_Resolve_KnownImportTip(t *testing.T) {
	withKnownEngineImportsForTest(t, []byte(`{
		"engines": [
			...
			{"id": "pydantic-ai", "import": "dsfaccini/gh-aw/.github/workflows/shared/pydantic.md@pydantic-ai-coder-engine"},
	...
	tests := []struct {
		...
		},
		{
			...
			wantImportPath: "dsfaccini/gh-aw/.github/workflows/shared/pydantic.md@pydantic-ai-coder-engine",
		},
		{
			name:           "custom tip",
			engineID:       "custom",
