...
func (e *ClaudeEngine) GetExecutionSteps(workflowData *WorkflowData, logFile string) []GitHubActionStep {
	...
	allowedTools := e.computeAllowedClaudeToolsString(effectiveTools, workflowData.SafeOutputs, workflowData.CacheMemoryConfig)
	if allowedTools != "" {
	...
	allowedToolsComment := e.generateAllowedToolsComment(e.computeAllowedClaudeToolsString(effectiveTools, workflowData.SafeOutputs, workflowData.CacheMemoryConfig), "        ")
