...
[ERROR] MCP server "github" Server stderr: Unable to find image 'ghcr.io/github/github-mcp-server:v0.18.0' locally
[DEBUG] Shell snapshot created successfully (242917 bytes)
[ERROR] MCP server "github" Server stderr: v0.18.0: Pulling from github/github-mcp-server
