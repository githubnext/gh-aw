...
func (c *Compiler) ParseWorkflowFile(markdownPath string) (*WorkflowData, error) {
	...
	// Extract YAML configuration sections from frontmatter (populates workflowData.Features among others)
	...
	// Validate feature-gated tool configurations (after extractYAMLSections+MergeFeatures populate workflowData.Features)
