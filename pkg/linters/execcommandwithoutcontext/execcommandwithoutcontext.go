...
func run(pass *analysis.Pass) (any, error) {
	...
	for cur := range insp.Root().Preorder((*ast.CallExpr)(nil)) {
		...
		checkExecCommandWithoutCtx(pass, cur, call, noLintIndex, generatedFiles)
	}

	return nil, nil
}

func checkExecCommandWithoutCtx(pass *analysis.Pass, cur inspector.Cursor, call *ast.CallExpr, noLintIndex nolint.DirectiveIndex, generatedFiles filecheck.GeneratedIndex) {
