...
func run(pass *analysis.Pass) (any, error) {
	...
	insp.Preorder(nodeFilter, func(n ast.Node) {
		checkAppendByteStringNode(pass, n, noLintIndex, generatedFiles)
	})

	return nil, nil
}

func checkAppendByteStringNode(pass *analysis.Pass, n ast.Node, noLintIndex nolint.DirectiveIndex, generatedFiles filecheck.GeneratedIndex) {
