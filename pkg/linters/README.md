...
- CI currently enforces the `errstringmatch`, `manualmutexunlock`, `panic-in-library-code`, `osexitinlibrary`, and `rawloginlib` analyzers via `.github/workflows/cgo.yml`.
