...
func run(pass *analysis.Pass) (any, error) {
	...
	for cursor := range insp.Root().Preorder((*ast.CallExpr)(nil)) {
		...
		checkHTTPCall(pass, cursor, call, noLintIndex, generatedFiles)
	}

	return nil, nil
}

func checkHTTPCall(pass *analysis.Pass, cursor inspector.Cursor, call *ast.CallExpr, noLintIndex nolint.DirectiveIndex, generatedFiles filecheck.GeneratedIndex) {
