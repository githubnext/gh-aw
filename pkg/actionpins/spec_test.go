...
func TestSpec_PublicAPI_GetContainerPin(t *testing.T) {
	...
	t.Run("returns pinned container for known image", func(t *testing.T) {
		// "ghcr.io/github/gh-aw-mcpg:v0.4.1" is present in the embedded action_pins.json containers map.
		pin, ok := actionpins.GetContainerPin("ghcr.io/github/gh-aw-mcpg:v0.4.1")
		require.True(t, ok, "should return true for a known container image")
		assert.Equal(t, "ghcr.io/github/gh-aw-mcpg:v0.4.1", pin.Image, "ContainerPin.Image should match the queried image")
