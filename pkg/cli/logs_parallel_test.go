...
func TestDownloadRunArtifactsParallel(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(context.Background(), []WorkflowRun{}, "./test-logs", false, 5, "", nil, false)
	if len(results) != 0 {
	...
	results = downloadRunArtifactsConcurrent(context.Background(), runs, "./test-logs", false, 5, "", nil, false)
...
func TestDownloadRunArtifactsParallelMaxRuns(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(context.Background(), runs, "./test-logs", false, 3, "", nil, false)
...
func TestDownloadRunArtifactsParallelWithCancellation(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(ctx, runs, "./test-logs", false, 5, "", nil, false)
