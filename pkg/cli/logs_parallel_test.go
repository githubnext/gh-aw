...
func TestDownloadRunArtifactsParallel(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(context.Background(), []WorkflowRun{}, "./test-logs", false, 5, "", nil, false, nil)
	if len(results) != 0 {
	...
	results = downloadRunArtifactsConcurrent(context.Background(), runs, "./test-logs", false, 5, "", nil, false, nil)
...
func TestDownloadRunArtifactsParallelMaxRuns(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(context.Background(), runs, "./test-logs", false, 3, "", nil, false, nil)
...
func TestDownloadRunArtifactsParallelWithCancellation(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(ctx, runs, "./test-logs", false, 5, "", nil, false, nil)
