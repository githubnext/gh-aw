...
func TestEngineFlagUsageText(t *testing.T) {
	...
	if engineFlag.Usage != "Override AI engine (copilot, claude, codex, gemini, antigravity, pi)" {
	...
	if filterFlag.Usage != "Filter logs by AI engine (copilot, claude, codex, gemini, antigravity, pi)" {
