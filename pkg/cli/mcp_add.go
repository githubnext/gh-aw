...
Registry URL defaults to: https://registry.modelcontextprotocol.io/v0`,
	...
	cmd.Flags().StringVar(&registryURL, "registry", "", "MCP registry URL (default: https://registry.modelcontextprotocol.io/v0)")
