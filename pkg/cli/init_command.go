...
- Creates the upgrade agentic workflow agent at .github/agents/upgrade-agentic-workflow.agent.md
...
- Use GitHub Copilot Chat: type /agent and select upgrade-agentic-workflow to upgrade workflows to the latest gh-aw version
