// This file provides rendering functions for MCP gateway metrics in gh-aw.
// It formats GatewayMetrics into human-readable console tables and aggregates
// metrics across multiple workflow runs for display.
