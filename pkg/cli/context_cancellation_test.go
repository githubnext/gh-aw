...
func TestDownloadWorkflowLogsWithCancellation(t *testing.T) {
	...
	err := DownloadWorkflowLogs(ctx, "", 10, "", "", "/tmp/test-logs", "", "", 0, 0, "", false, false, false, false, false, false, false, 0, false, "", "never")
...
func TestDownloadWorkflowLogsTimeoutRespected(t *testing.T) {
	...
	_ = DownloadWorkflowLogs(ctx, "nonexistent-workflow-12345", 100, "", "", "/tmp/test-logs", "", "", 0, 0, "", false, false, false, false, false, false, false, 1, false, "", "never")
