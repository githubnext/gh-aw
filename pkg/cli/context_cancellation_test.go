...
func TestRunWorkflowOnGitHubWithCancellation(t *testing.T) {
	...
	err := RunWorkflowOnGitHub(ctx, "test-workflow", false, "", "", "", false, false, false, []string{}, false, false)
...
func TestRunWorkflowsOnGitHubWithCancellation(t *testing.T) {
	...
	err := RunWorkflowsOnGitHub(ctx, []string{"test-workflow"}, 0, false, "", "", "", false, false, []string{}, false, false)
...
func TestRunWorkflowsOnGitHubCancellationDuringExecution(t *testing.T) {
	...
	err := RunWorkflowsOnGitHub(ctx, []string{"nonexistent-workflow-1", "nonexistent-workflow-2"}, 0, false, "", "", "", false, false, []string{}, false, false)
