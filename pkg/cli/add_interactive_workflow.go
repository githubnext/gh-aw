...
func (c *AddInteractiveConfig) checkStatusAndOfferRun(ctx context.Context) error {
	...
	workflowFound, err := c.checkStatusAndOfferRunWaitForWorkflow(ctx)
	if err != nil {
		return err
	}
	...
	return c.checkStatusAndOfferRunOffer(ctx)
}

func (c *AddInteractiveConfig) checkStatusAndOfferRunWaitForWorkflow(ctx context.Context) (bool, error) {
	...
	for i := range 5 {
		found, err := c.checkStatusAndOfferRunAttempt(ctx, i)
		if err != nil || found {
			return found, err
		}
	}
...
func (c *AddInteractiveConfig) checkStatusAndOfferRunAttempt(ctx context.Context, i int) (bool, error) {
...
func (c *AddInteractiveConfig) checkStatusAndOfferRunOffer(ctx context.Context) error {
	if c.checkStatusAndOfferRunShouldSkipOffer() {
		return nil
	}
	...
	if err := c.checkStatusAndOfferRunRunWorkflow(ctx); err != nil {
		return err
	}
...
func (c *AddInteractiveConfig) checkStatusAndOfferRunShouldSkipOffer() bool {
...
func (c *AddInteractiveConfig) checkStatusAndOfferRunRunWorkflow(ctx context.Context) error {
	...
	fmt.Fprintln(os.Stderr, "")
	c.checkStatusAndOfferRunUpdateLocalBranch()
	...
	c.checkStatusAndOfferRunPrintRunURL(workflowName)
	return nil
}

func (c *AddInteractiveConfig) checkStatusAndOfferRunUpdateLocalBranch() {
...
func (c *AddInteractiveConfig) checkStatusAndOfferRunPrintRunURL(workflowName string) {
