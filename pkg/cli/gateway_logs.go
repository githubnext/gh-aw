...
// This file (gateway_logs.go) contains types, constants, logger, and core helpers
// for parsing and analyzing MCP gateway logs from gateway.jsonl or rpc-messages.jsonl files.
//
// Key responsibilities:
//   - Type definitions for gateway log entries and metrics
//   - Guard policy error code constants
//   - Core helper: isGuardPolicyErrorCode
//
// See also:
//   - gateway_logs_parser.go   — RPC/gateway log parsing functions
//   - gateway_logs_renderer.go — console table rendering functions
//   - gateway_logs_extractor.go — high-level MCP tool usage extraction
