...
// This file (gateway_logs.go) contains types, constants, and entry-point functions
// for parsing and analyzing MCP gateway logs.
//
// Key responsibilities:
//   - Type definitions for gateway log entries, metrics, and RPC messages
//   - Entry-point for parsing gateway logs (parseGatewayLogs)
//   - Helper utilities: getOrCreateServer, getOrCreateTool, calculateGatewayAggregates
//
// Related files:
//   - gateway_logs_parser.go  — parseRPCMessages, processGatewayLogEntry, buildToolCallsFromRPCMessages
//   - gateway_logs_mcp.go     — extractMCPToolUsageData
//   - gateway_logs_policy.go  — guard policy error classification and summary building
...
// isGuardPolicyErrorCode and guardPolicyReasonFromCode are in gateway_logs_policy.go.
// buildGuardPolicySummary is in gateway_logs_policy.go.
