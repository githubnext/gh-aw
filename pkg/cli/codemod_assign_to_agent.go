...
func getAssignToAgentDefaultAgentCodemod() Codemod {
	return Codemod{
		...
		Apply: func(content string, frontmatter map[string]any) (string, bool, error) {
			return getAssignToAgentDefaultAgentCodemodApply(content, frontmatter)
		},
	}
}

func getAssignToAgentDefaultAgentCodemodApply(content string, frontmatter map[string]any) (string, bool, error) {
	...
	newContent, applied, err := applyFrontmatterLineTransform(content, getAssignToAgentDefaultAgentCodemodTransformLines)
	if applied {
...
func getAssignToAgentDefaultAgentCodemodTransformLines(lines []string) ([]string, bool) {
	var modified bool
