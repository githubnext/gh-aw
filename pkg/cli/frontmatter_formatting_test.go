...
// This is the scenario from the add-wizard bug where engine: { id: claude } was updated to
// engine: copilot but the child "  id: claude" line remained, producing invalid YAML.
