...
// This file (gateway_logs_parser.go) contains log parsing functions for
// MCP gateway logs — parsing rpc-messages.jsonl and gateway.jsonl formats,
// and building MCPToolCall records from RPC message traces.
