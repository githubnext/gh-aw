// This file provides type definitions for gateway log parsing and metrics.
//
// Types defined here are used across the gateway log sub-files:
//   - gateway_logs_parser.go   — parseRPCMessages, findRPCMessagesPath, parseGatewayLogs
//   - gateway_logs_metrics.go  — processGatewayLogEntry, getOrCreateServer, calculateGatewayAggregates
//   - gateway_logs_render.go   — renderGatewayMetricsTable, displayAggregatedGatewayMetrics
