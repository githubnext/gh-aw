...
func TestRunWorkflowOnGitHub(t *testing.T) {
	...
	err := RunWorkflowOnGitHub("", false, "", "", false, false, false, false, false)
	if err == nil {
	...
	err = RunWorkflowOnGitHub("nonexistent-workflow", false, "", "", false, false, false, false, false)
	if err == nil {
...
func TestRunWorkflowsOnGitHub(t *testing.T) {
	...
	err := RunWorkflowsOnGitHub([]string{}, 0, false, "", "", false, false, false, false)
	if err == nil {
		t.Error("RunWorkflowsOnGitHub should return error for empty workflow list")
	}

	// Test with workflow list containing empty name
	err = RunWorkflowsOnGitHub([]string{"valid-workflow", ""}, 0, false, "", "", false, false, false, false)
	if err == nil {
	...
	err = RunWorkflowsOnGitHub([]string{"nonexistent-workflow1", "nonexistent-workflow2"}, 0, false, "", "", false, false, false, false)
	if err == nil {
	...
	err = RunWorkflowsOnGitHub([]string{"nonexistent-workflow"}, -1, false, "", "", false, false, false, false)
	if err == nil {
...
Test workflow for command existence.`
	...
	tests := []struct {
		...
		{func() error { return RunWorkflowOnGitHub("", false, "", "", false, false, false, false, false) }, true, "RunWorkflowOnGitHub"},       // Should error with empty workflow name
		{func() error { return RunWorkflowsOnGitHub([]string{}, 0, false, "", "", false, false, false, false) }, true, "RunWorkflowsOnGitHub"}, // Should error with empty workflow list
	}
...
func TestRunWorkflowOnGitHubWithEnable(t *testing.T) {
	...
	err := RunWorkflowOnGitHub("nonexistent-workflow", true, "", "", false, false, false, false, false)
	if err == nil {
	...
	err = RunWorkflowOnGitHub("", true, "", "", false, false, false, false, false)
	if err == nil {
