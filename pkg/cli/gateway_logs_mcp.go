...
// This file (gateway_logs_mcp.go) contains MCP tool usage extraction logic
// for MCP gateway logs — aggregating per-server and per-tool statistics
// into MCPToolUsageData for report building.
