...
type defaultsFile struct {
	...
	DefaultMaxCacheMisses        *string `yaml:"default_max_cache_misses"`
...
var defaultsBindings = []defaultsBinding{
	...
	{envName: compilerenv.DefaultMaxCacheMisses, fieldName: "default_max_cache_misses", get: func(f *defaultsFile) **string { return &f.DefaultMaxCacheMisses }},
...
func defaultsValidateFile(file *defaultsFile) error {
	...
	validatePositiveInt("default_max_cache_misses", file.DefaultMaxCacheMisses)
