...
type logsArgs struct {
	...
	Artifacts         []string `json:"artifacts,omitempty" jsonschema:"Artifact sets to download (default: usage). Valid sets: all, activation, agent, detection, evals, experiment, firewall, github-api, mcp, safe-outputs, usage"`
}
...
type auditArgs struct {
	...
	Artifacts    []string `json:"artifacts,omitempty"        jsonschema:"Artifact sets to download (default: all). Valid sets: all, activation, agent, detection, evals, experiment, firewall, github-api, mcp, safe-outputs, usage"`
...
- jobs: List of job details (name, status, conclusion, duration, steps with error_excerpt for failed steps)
