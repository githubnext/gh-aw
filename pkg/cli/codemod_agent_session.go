...
func getAgentTaskToAgentSessionCodemod() Codemod {
	return Codemod{
		...
		Apply: func(content string, frontmatter map[string]any) (string, bool, error) {
			return getAgentTaskToAgentSessionCodemodApply(content, frontmatter)
		},
	}
}

func getAgentTaskToAgentSessionCodemodApply(content string, frontmatter map[string]any) (string, bool, error) {
	...
	newContent, applied, err := applyFrontmatterLineTransform(content, getAgentTaskToAgentSessionCodemodTransformLines)
	if applied {
...
func getAgentTaskToAgentSessionCodemodTransformLines(lines []string) ([]string, bool) {
	var modified bool
