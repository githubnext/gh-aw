...
func TestFindSimilarParam(t *testing.T) {
	compileParams := []string{"actionlint", "fix", "grype", "max_tokens", "poutine", "runner-guard", "strict", "workflows", "yamllint", "zizmor"}
...
func TestArgumentValidationMiddleware_TransformsAdditionalPropertiesError(t *testing.T) {
	toolParams := map[string]toolParamEntry{
		"compile": {"actionlint", "fix", "grype", "max_tokens", "poutine", "runner-guard", "strict", "workflows", "yamllint", "zizmor"},
	}
