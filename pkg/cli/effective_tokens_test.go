...
func TestComputeModelEffectiveTokensWithWeights_UnknownModelFallbackAndEffectiveInput(t *testing.T) {
	...
	et := computeModelEffectiveTokensWithWeights("unknown-model", "anthropic", tokenCounts{
		inputTokens:      50,
		outputTokens:     80,
		cacheReadTokens:  100,
		cacheWriteTokens: 0,
...
func TestComputeModelEffectiveTokensWithWeights_NoCacheReadSubtractionForUnknownProvider(t *testing.T) {
	...
	et := computeModelEffectiveTokensWithWeights("unknown-model", "test-provider", tokenCounts{
		inputTokens:      50,
		outputTokens:     80,
		cacheReadTokens:  100,
		cacheWriteTokens: 0,
	...
	etBundled := computeModelEffectiveTokensWithWeights("unknown-model", "anthropic", tokenCounts{
		inputTokens:      50,
		outputTokens:     80,
		cacheReadTokens:  100,
		cacheWriteTokens: 0,
