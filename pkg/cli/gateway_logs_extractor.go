// This file provides high-level MCP tool usage extraction functions for gh-aw.
// It combines gateway metrics and individual tool call records into structured
// MCPToolUsageData and GuardPolicySummary for reporting and audit output.
