...
func TestDownloadRunArtifactsConcurrent_EmptyRuns(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(ctx, []WorkflowRun{}, "./test-logs", false, 5, "", nil, false)
...
func TestDownloadRunArtifactsConcurrent_ResultOrdering(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(ctx, runs, tmpDir, false, 5, "", nil, false)
...
func TestDownloadRunArtifactsConcurrent_AllProcessed(t *testing.T) {
	...
	results := downloadRunArtifactsConcurrent(ctx, runs, tmpDir, false, 3, "", nil, false)
...
func TestDownloadRunArtifactsConcurrent_PartialCancellation(t *testing.T) {
	...
	tmpDir := testutil.TempDir(t, "test-orchestrator-*")
	results := downloadRunArtifactsConcurrent(ctx, runs, tmpDir, false, 20, "", nil, false)
...
func TestDownloadRunArtifactsConcurrent_ConcurrencyLimit(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tmpDir := testutil.TempDir(t, "test-orchestrator-*")
			results := downloadRunArtifactsConcurrent(context.Background(), runs, tmpDir, false, tt.runs, "", nil, false)
...
func TestDownloadRunArtifactsConcurrent_LogsPath(t *testing.T) {
	...
	tmpDir := testutil.TempDir(t, "test-orchestrator-*")
	results := downloadRunArtifactsConcurrent(ctx, runs, tmpDir, false, 2, "", nil, false)
...
func TestDownloadRunArtifactsConcurrent_VerboseMode(t *testing.T) {
	...
	resultsNonVerbose := downloadRunArtifactsConcurrent(ctx, runs, tmpDir, false, 2, "", nil, false)
	require.Len(t, resultsNonVerbose, 2, "Non-verbose mode should return 2 results")

	// Test with verbose=true
	resultsVerbose := downloadRunArtifactsConcurrent(ctx, runs, tmpDir, true, 2, "", nil, false)
...
func TestDownloadRunArtifactsConcurrent_ResultStructure(t *testing.T) {
	...
	tmpDir := testutil.TempDir(t, "test-orchestrator-*")
	results := downloadRunArtifactsConcurrent(ctx, []WorkflowRun{run}, tmpDir, false, 1, "", nil, false)
