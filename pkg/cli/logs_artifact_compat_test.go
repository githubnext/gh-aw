...
type artifactNamingCompatibilityTestCase struct {
	name               string
...
func artifactNamingCompatibilityTestCases() []artifactNamingCompatibilityTestCase {
	return []artifactNamingCompatibilityTestCase{
		{name: "old aw_info artifact", artifactDirName: "aw_info", fileNameInArtifact: "aw_info.json", expectedFileName: "aw_info.json"},
		{name: "old safe_output artifact", artifactDirName: "safe_output", fileNameInArtifact: "safe_output.jsonl", expectedFileName: "safe_output.jsonl"},
		{name: "old agent_output artifact", artifactDirName: "agent_output", fileNameInArtifact: "agent_output.json", expectedFileName: "agent_output.json"},
		{name: "old prompt artifact", artifactDirName: "prompt", fileNameInArtifact: "prompt.txt", expectedFileName: "prompt.txt"},
		{name: "new aw-info artifact", artifactDirName: "aw-info", fileNameInArtifact: "aw_info.json", expectedFileName: "aw_info.json"},
		{name: "new safe-output artifact", artifactDirName: "safe-output", fileNameInArtifact: "safe_output.jsonl", expectedFileName: "safe_output.jsonl"},
		{name: "new agent-output artifact", artifactDirName: "agent-output", fileNameInArtifact: "agent_output.json", expectedFileName: "agent_output.json"},
		{name: "new prompt artifact (unchanged)", artifactDirName: "prompt", fileNameInArtifact: "prompt.txt", expectedFileName: "prompt.txt"},
		{name: "old threat-detection.log artifact (legacy)", artifactDirName: constants.LegacyDetectionArtifactName, fileNameInArtifact: "detection.log", expectedFileName: "detection.log"},
		{name: "new detection artifact", artifactDirName: constants.DetectionArtifactName, fileNameInArtifact: "detection.log", expectedFileName: "detection.log"},
	}
}

func assertArtifactFlattening(t *testing.T, tt artifactNamingCompatibilityTestCase) {
	t.Helper()
...
func TestArtifactNamingBackwardCompatibility(t *testing.T) {
	for _, tt := range artifactNamingCompatibilityTestCases() {
		t.Run(tt.name, func(t *testing.T) {
			assertArtifactFlattening(t, tt)
		})
	}
}
