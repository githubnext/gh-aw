...
type ImportsResult struct {
	...
	MergedMaxDailyEffectiveTokens string                // First max-daily-ai-credits (or deprecated max-daily-effective-tokens) value found across all imports (JSON-encoded, first-wins)
