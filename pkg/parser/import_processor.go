...
type ImportsResult struct {
	...
	MergedMarketplaces          []string         // Merged marketplace URLs from all imports (union, deduplicated)
	MergedPlugins               []string         // Merged plugin names from all imports (union, deduplicated)
