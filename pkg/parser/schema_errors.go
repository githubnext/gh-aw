...
var knownFieldValidValues = map[string]string{
	...
	"/permissions": "Valid permission scopes: actions, all, attestations, checks, contents, dependabot-alerts, deployments, discussions, id-token, issues, metadata, models, organization-projects, packages, pages, pull-requests, repository-projects, security-events, statuses",
}
