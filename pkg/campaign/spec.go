...
type CampaignSpec struct {
	...
	// This field is required because campaigns are designed for active orchestration
	// of worker workflows toward a goal. For passive monitoring of project boards
	// without workflow orchestration, use ProjectOps features instead.
