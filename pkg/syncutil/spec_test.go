...
func TestSpec_PublicAPI_OnceLoader_Get(t *testing.T) {
	...
	t.Run("documented: caches error alongside zero value of T", func(t *testing.T) {
		...
		assert.ErrorIs(t, err1, boom, "first Get error should match loader error")
		assert.ErrorIs(t, err2, boom, "subsequent Get error should match cached loader error")
	...
	t.Run("documented: caches error alongside zero value of T for non-string types", func(t *testing.T) {
		...
		assert.ErrorIs(t, err1, boom, "first Get error should match loader error")
		assert.ErrorIs(t, err2, boom, "subsequent Get error should match cached error")
