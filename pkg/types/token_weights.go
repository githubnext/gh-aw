...
// TokenClassWeights holds per-token-class weights for legacy effective token (ET) computation.
...
// TokenWeights defines custom model cost information for legacy ET computation and AI Credits cost ratios.
