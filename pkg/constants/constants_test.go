...
func TestVersionConstants(t *testing.T) {
	tests := []struct {
		...
		{"DefaultClaudeCodeVersion", DefaultClaudeCodeVersion, "2.0.65"},
		{"DefaultCopilotVersion", DefaultCopilotVersion, "0.0.368"},
		{"DefaultCodexVersion", DefaultCodexVersion, "0.69.0"},
