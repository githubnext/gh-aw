...
func TestVersionConstants(t *testing.T) {
	tests := []struct {
		...
		{"DefaultClaudeCodeVersion", DefaultClaudeCodeVersion, "2.0.58"},
		{"DefaultCopilotVersion", DefaultCopilotVersion, "0.0.366"},
		{"DefaultCodexVersion", DefaultCodexVersion, "0.64.0"},
