...
func TestVersionConstants(t *testing.T) {
	tests := []struct {
		...
		{"DefaultClaudeCodeVersion", DefaultClaudeCodeVersion, "2.0.49"},
		{"DefaultCopilotVersion", DefaultCopilotVersion, "0.0.362"},
		{"DefaultCodexVersion", DefaultCodexVersion, "0.61.0"},
