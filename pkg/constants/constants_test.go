...
func TestModelNameConstants(t *testing.T) {
	...
	tests := []struct {
		...
		{"DefaultCopilotAgentModel", DefaultCopilotAgentModel, "claude-sonnet-4"},
	}
...
func TestVersionConstants(t *testing.T) {
	tests := []struct {
		...
		{"DefaultClaudeCodeVersion", DefaultClaudeCodeVersion, "2.1.12"},
		{"DefaultCopilotVersion", DefaultCopilotVersion, "0.0.387"},
		{"DefaultCodexVersion", DefaultCodexVersion, "0.87.0"},
		{"DefaultGitHubMCPServerVersion", DefaultGitHubMCPServerVersion, "v0.29.0"},
		{"DefaultMCPGatewayVersion", DefaultMCPGatewayVersion, "v0.0.71"},
		{"DefaultSandboxRuntimeVersion", DefaultSandboxRuntimeVersion, "0.0.28"},
...
func TestSemanticTypeAliases(t *testing.T) {
	...
	t.Run("ModelName type", func(t *testing.T) {
		...
		// Test DefaultCopilotAgentModel has the correct type
		agentModel := DefaultCopilotAgentModel
		if string(agentModel) != "claude-sonnet-4" {
			t.Errorf("DefaultCopilotAgentModel = %q, want %q", agentModel, "claude-sonnet-4")
		}
	})
