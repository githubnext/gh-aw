...
// GhSkillsMinVersion is the minimum gh CLI version required for skill support.
// Workflows that install frontmatter skills must have at least this version of gh installed.
