...
const DefaultClaudeCodeVersion Version = "2.1.204"
...
const DefaultCopilotVersion Version = "1.0.69"
...
const DefaultCodexVersion Version = "0.143.0"
...
const DefaultFirewallVersion Version = "v0.27.27"
...
// The first recompile regenerates all lock files using the new version; the second recompile
// refreshes the container SHA pins that were resolved during the first pass.
const DefaultMCPGatewayVersion Version = "v0.4.0"
