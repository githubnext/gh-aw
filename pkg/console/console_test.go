...
func TestFormatNestedError(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "error with URL keeps URL protocol together",
			message: "failed to fetch: https://api.github.com/repos/owner/repo: connection timeout",
			expected: []string{
				"✗",
				"failed to fetch",
				"╰─▶",
		...
		{
			name:    "error with file path line:column",
			message: "failed to compile: /path/to/file.go:123:45: syntax error",
			expected: []string{
				"✗",
				"failed to compile",
				"╰─▶",
				"/path/to/file.go:123:45",
				"╰─▶",
				"syntax error",
			},
		},
		{
			...
			expected: []string{
				...
				"╰─▶",
				".github/workflows/daily-team-status.md:1:1",
				"error",
