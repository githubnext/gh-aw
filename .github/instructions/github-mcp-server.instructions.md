...
### Migration Guide: From `allowed:` to `toolset:`

When you see workflows using `allowed:` to list individual tools, migrate them to use `toolset:` instead:

**Example 1: Pull Request Workflows**
```yaml
# Before
tools:
  github:
...
**Example 4: Comprehensive Workflows**
```yaml
# Before
tools:
  github:
...
tools:
  github:
    toolset: [default]  # Includes repos, issues, pull_requests, context, users
```
