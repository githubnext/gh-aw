---
description: Weekly report tracking Copilot token consumption and costs across all agentic workflows with trend analysis
on:
  schedule:
...
permissions:
  ...
  issues: read
  pull-requests: read
tracker-id: weekly-copilot-token-report
engine: copilot
tools:
  cache-memory:
    - id: token-metrics
...
# Weekly Copilot Token Consumption Report
...
```markdown
# 📊 Weekly Copilot Token Consumption Report - [DATE]
...
*Generated by Weekly Copilot Token Consumption Report*
