...
## DO NOT ADD FOOTER TO COMMENTS

**CRITICAL**: When using `safe-outputs.add-comment`, do NOT add any footer lines like `> AI generated by...` to your comment content. The system will automatically add an attribution footer after your content.

**Why this matters:**
- The `add_comment.cjs` script automatically appends a footer with workflow attribution
- If you include a footer in your output, it will result in duplicate footers
- AI agents may learn footer patterns from reading previous comments and replicate them

**What to do:**
- End your comment with the closing `</details>` tag or the last line of your content
- Do NOT include lines starting with `>` that contain "AI generated by" or similar attribution text
- Let the system handle all attribution automatically
