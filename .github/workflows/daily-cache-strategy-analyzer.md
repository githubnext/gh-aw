...
experiments:
  model_size:
    variants: [gpt-5.4, gpt-5.5]
    description: "Compares codex-compatible models for cache issue detection quality and efficiency."
    hypothesis: "H0: no change in issue creation rate or run success rate. H1: gpt-5.5 reduces AI Credits while keeping run success rate >=0.90."
