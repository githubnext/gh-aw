...
3. **Playwright MCP Testing**: Use the Playwright MCP `browser_navigate` tool to navigate to https://github.com, then use `browser_snapshot` to verify the page title contains "GitHub".
