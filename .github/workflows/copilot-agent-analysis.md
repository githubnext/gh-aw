...
Use the repo memory folder `/tmp/gh-aw/repo-memory-default/memory/default/` to maintain historical data:

#### 4.1 Load Historical Data

Check for existing historical data:
```bash
ls -la /tmp/gh-aw/repo-memory-default/memory/default/copilot-agent-metrics/
cat /tmp/gh-aw/repo-memory-default/memory/default/copilot-agent-metrics/history.json
```
...
Save to repo memory:
```bash
mkdir -p /tmp/gh-aw/repo-memory-default/memory/default/copilot-agent-metrics/
