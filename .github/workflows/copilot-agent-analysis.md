...
When drafting the discussion body, use only the inline skill that matches the active `output_format` experiment variant:

- `copilot-agent-analysis-structured-output` for `structured`
- `copilot-agent-analysis-prose-output` for `prose`
...
## skill: `copilot-agent-analysis-structured-output`
---
description: Structured output template for the structured output_format experiment variant
---
...
## skill: `copilot-agent-analysis-prose-output`
---
description: Prose output template for the prose output_format experiment variant
---
