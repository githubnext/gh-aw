...
## 🤖 Instructions for Copilot Coding Agent (Phase 2)

You are the Phase 2 compiler for this campaign. Phase 1 has already created the campaign specification file. Your role is to compile it and create a pull request.

### What Phase 1 Already Completed:
- ✅ Created GitHub Project board
- ✅ Discovered workflows using catalog
...
If the file doesn't exist, report to this issue and stop.
...
- Report errors to this issue if you can't fix them
...
3. ⏳ **Awaiting Copilot Coding Agent compilation (you are assigned to this task)**
...
I've generated the campaign specification and updated the issue with detailed compilation instructions.

📁 **File Created:**
- `.github/workflows/<campaign-id>.campaign.md`

🔄 **Next Steps:**
1. Copilot Coding Agent has been assigned to this issue
2. The agent will compile the campaign using `gh aw compile`
3. The agent will create a pull request with all files

**Estimated time:** Copilot Coding Agent will compile in 1-2 minutes

All compilation instructions are included in the issue body above.
```
...
**All instructions are in the issue body:**
The Copilot Coding Agent will read the issue body which contains:
- Campaign ID and file paths
- Step-by-step compilation instructions
- PR template to use
- What NOT to do (already completed in Phase 1)
...
4. Post success comment to the issue

**Files that will be created:**
- `.github/workflows/<campaign-id>.campaign.md` (already exists)
- `.github/workflows/<campaign-id>.campaign.g.md` (to be generated)
- `.github/workflows/<campaign-id>.campaign.lock.yml` (to be generated)
