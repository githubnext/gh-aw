...
- get the current time using the get_current_time tool to timestamp your analysis.

- append the current time to the $GITHUB_STEP_SUMMARY file (markdown format). The environment GITHUB_STEP_SUMMARY points to a filename that is used for logging. You should only append to it.

Once, you're done, you can start the Analysis:
