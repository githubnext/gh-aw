...
The campaign uses a GitHub Project board for tracking: https://github.com/orgs/githubnext/projects/60
...
If you need to update project metadata or status fields for campaign coordination, use the `update-project` safe output with this exact URL: https://github.com/orgs/githubnext/projects/60
