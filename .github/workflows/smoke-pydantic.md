...
safe-outputs:
    ...
    messages:
      ...
      run-success: "🚀 [{workflow_name}]({run_url}) **MISSION COMPLETE!** Pydantic AI delivered. 🐍"
...
3. **File Writing Testing**: Create a test file `/tmp/gh-aw/agent/smoke-test-pydantic-${{ github.run_id }}.txt` with content "Smoke test passed for Pydantic AI at $(date)" (create the directory if it doesn't exist)
