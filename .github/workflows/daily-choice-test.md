...
<details>
<summary><b>Selection Criteria Reference</b></summary>

| Day | Environment | Test Type |
|-----|-------------|-----------|
| Monday | staging | smoke |
| Tuesday | production | integration |
| Wednesday | staging | smoke |
| Thursday | production | integration |
| Friday | staging | smoke |
