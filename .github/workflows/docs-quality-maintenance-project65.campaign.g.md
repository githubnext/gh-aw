...
on:
  ...
  workflow_dispatch:
concurrency:
  group: "campaign-docs-quality-maintenance-project65-orchestrator-${{ github.ref }}"
...
tools:
    ...
    repo-memory:
        - branch-name: memory/campaigns
          campaign-id: docs-quality-maintenance-project65
          file-glob:
            - docs-quality-maintenance-project65/**
          id: campaigns
---

<!-- This file was automatically generated by gh-aw. DO NOT EDIT. -->
<!-- Source: .github/workflows/docs-quality-maintenance-project65.campaign.md -->
...
**Cursor file (repo-memory)**: `memory/campaigns/docs-quality-maintenance-project65/cursor.json`
...
**Metrics/KPI snapshots (repo-memory)**: `memory/campaigns/docs-quality-maintenance-project65/metrics/*.json`
...
```json
{
  "campaign_id": "docs-quality-maintenance-project65",
  "date": "YYYY-MM-DD",
  "tasks_total": 0,
  "tasks_completed": 0,
  "tasks_in_progress": 0,
...
- `campaign_id` (string): Must be exactly "docs-quality-maintenance-project65"
