...
- [ ] **Create a changeset file in `.changeset/` directory** - Create a file like `major-breaking-change-description.md` with the change details. The release script computes the semver change level from these files. See [specs/changesets.md](specs/changesets.md) for format details.
