...
- **Actor**: ${{ github.actor }}
- **Hard Turn Budget**: 8 turns maximum — stop as soon as you can issue a safe output
...
| **Total** | **≤ 7** | *(turn 8 is reserved: if no safe output by turn 7, emit best available output on turn 8)* |
...
- **Turn 7 reached**: If you are on turn 7 and have not yet called a safe output, emit the best available output immediately on turn 8 — do not start a new investigation step. Turn 8 is the hard limit enforced by the engine.
