...
See [triggers.md](triggers.md) for the full decision matrix, compact scenario examples, pattern-specific `noop` rules, and the `workflow_run` vs `deployment_status` guidance.
