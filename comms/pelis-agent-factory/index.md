...
Peli's Agent Factory is a research collaboration between GitHub Next and Microsoft Research (MSR), exploring what happens when you build and operate dozens of specialized AI agents within a real software repository. Led by Peli de Halleux and the GitHub Next Agentic Workflows team, this project demonstrates the frontier of automated, proactive software development assistance.
