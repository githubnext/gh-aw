 ...
 * @returns {(item: {type: string, url?: string, number?: number, repo?: string, temporaryId?: string, before_state?: Object, after_state?: Object, metadata?: Record<string, any>, labelsAdded?: string[], labelsBefore?: string[]}) => void} Logger function
 */
function createManifestLogger(manifestFile = MANIFEST_FILE_PATH) {
   ...
   *
   * @param {{type: string, url?: string, number?: number, repo?: string, temporaryId?: string, before_state?: Object, after_state?: Object, metadata?: Record<string, any>, labelsAdded?: string[], labelsBefore?: string[]}} item - Executed item details
   */
 ...
 * @returns {{type: string, url?: string, number?: number, repo?: string, temporaryId?: string, before_state?: Object, after_state?: Object, metadata?: Record<string, any>, labelsAdded?: string[], labelsBefore?: string[]}|null}
 */
