...
describe("handle_agent_failure.cjs", () => {
  ...
  describe("when agent job failed", () => {
    ...
    it("should add a comment to existing issue when found", async () => {
      ...
      expect(commentCall.body).toContain("agent job failed during [workflow run]");
      expect(commentCall.body).toContain("### How to investigate");
      expect(commentCall.body).toContain("debug-agentic-workflow");
