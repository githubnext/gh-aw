...
async function main(config = {}) {
  ...
  return async function handleCreateDiscussion(message, resolvedTemporaryIds) {
    ...
    const footer = addExpirationToFooter(generateFooter(workflowName, runUrl, workflowSource, workflowSourceURL, triggeringIssueNumber, triggeringPRNumber, triggeringDiscussionNumber).trimEnd(), expiresHours, "Discussion");
