...
describe("messages.cjs", () => {
  ...
  describe("getFooterMessage", () => {
    ...
    it("should include ambient context in the default footer when GH_AW_AMBIENT_CONTEXT is set", async () => {
      ...
      expect(result).toBe("> Generated by [Test Workflow](https://github.com/test/repo/actions/runs/123) · ⊞ 900 ambient context");
    });
    ...
    it("should place ambient context after threat-detection AI Credits in the default footer", async () => {
      ...
      expect(result).toBe("> Generated by [Test Workflow](https://github.com/test/repo/actions/runs/123) · 0.125 AIC · ⌖ 0.025 AIC · ⊞ 900 ambient context");
    });
