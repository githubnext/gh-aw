  ...
  (describe("interpolateVariables", () => {
    ...
    describe("renderMarkdownTemplate", () => {
      (it("should keep content in truthy blocks", () => {
        ...
        it("should handle {{else}} with (eq VALUE LITERAL) condition matching", () => {
          // Simulates what happens after experiment substitution: (eq concise "concise")
          ...
          const verboseOutput = renderMarkdownTemplate('{{#if (eq verbose "concise")}}\nConcise content\n{{else}}\nVerbose content\n{{/if}}');
