 ...
 * @returns {Array<{denialCount: number, threshold: number, reason: string, recentToolCalls: Array<string>}>}
 */
 ...
 * @param {Array<{denialCount: number, threshold: number, reason: string, recentToolCalls?: Array<string>}>} events
