...
const { resolveFirewallAuditLogPath, resolveAICreditsFailureState, parseMaxAICreditsFromAuditLog, parseAICreditsErrorInfoFromAuditLog, parseMaxAICreditsExceededFromAuditLog } = require("./ai_credits_context.cjs");
