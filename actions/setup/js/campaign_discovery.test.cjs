...
import { normalizeItem, loadCursor, saveCursor, searchByTrackerId, searchByLabel, searchItems, buildScopeParts, discover, discoverSecurityAlerts } from "./campaign_discovery.cjs";
import fs from "fs";
