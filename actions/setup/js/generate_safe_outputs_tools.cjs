...
async function main() {
  ...
  /** @type {{description_suffixes?: Record<string, string>, repo_params?: Record<string, {type: string, description: string}>, required_field_removals?: Record<string, string[]>, dynamic_tools?: Array<unknown>}} */
