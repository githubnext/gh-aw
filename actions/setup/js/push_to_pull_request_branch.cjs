 ...
 * @param {string} opts.baseRef - Git ref of the remote head before the patch was applied (used for rev-list)
...
async function pushSignedCommits({ githubClient, owner, repo, branch, baseRef, cwd, gitAuthEnv }) {
  // Collect the commits introduced by git am (oldest-first)
