...
function extractCommentMemoryEntries(commentBody, warn = () => {}) {
  ...
  // eslint-disable-next-line gh-aw-custom/require-escaped-regexp-interpolation -- MAX_MEMORY_ID_LENGTH is a numeric constant used as a regex quantifier, not user-controlled input
