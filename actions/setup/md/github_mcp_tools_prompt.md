...
**Code Scanning**: When calling `list_code_scanning_alerts`, always include `state: open` and `severity: critical,high` to bound the request and prevent oversized responses.
</github-mcp-tools>
