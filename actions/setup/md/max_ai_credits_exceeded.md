> [!WARNING]
> **AI Credits Budget Exhausted**
>
> The workflow's per-run AI credits budget (`max-ai-credits`) was exhausted and the agent was stopped by the harness.{metrics_table}
