...
When no action is needed, call `noop` with a short status message explaining what you checked and why no action was required. Never skip `noop` due to missing prompt instructions.
