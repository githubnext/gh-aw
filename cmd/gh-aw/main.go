...
You will need to start a new shell for this setup to take effect.`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fixed := cli.FixCompletionScript(buf.String(), "bash")
...
You will need to start a new shell for this setup to take effect.`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fixed := cli.FixCompletionScript(buf.String(), "zsh")
			fmt.Fprint(os.Stdout, fixed)
			return nil
		},
	}
...
You will need to start a new shell for this setup to take effect.`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fixed := cli.FixCompletionScript(buf.String(), "fish")
			fmt.Fprint(os.Stdout, fixed)
			return nil
		},
	}
...
Use "` + string(constants.CLIExtensionPrefix) + ` help all" to show help for all commands.`,
	...
	// Override Cobra's auto-generated completion command with our own that fixes "gh aw"
