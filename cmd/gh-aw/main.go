...
func getCompileCmdOptions(cmd *cobra.Command) compileCmdOptions {
	...
	return compileCmdOptions{
		...
		zizmor: zizmor, poutine: poutine, actionlint: actionlint, runnerGuard: runnerGuard, syft: syft, grype: grype, grant: grant, yamllint: yamllint,
...
func (o *compileCmdOptions) toCompileConfig(args []string) cli.CompileConfig {
	return cli.CompileConfig{
		...
		Syft: o.syft, Grype: o.grype, Grant: o.grant, Yamllint: o.yamllint, JSONOutput: o.jsonOutput, ShowAllErrors: o.showAllErrors,
