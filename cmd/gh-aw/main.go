...
Use "` + string(constants.CLIExtensionPrefix) + ` help all" to show help for all commands.`,
	...
	newCmd.Flags().StringP("engine", "e", "", "Override AI engine (copilot, claude, codex, gemini, antigravity, crush)")
	cli.RegisterEngineFlagCompletion(newCmd)

	// Add AI flag to compile and add commands
	compileCmd.Flags().StringP("engine", "e", "", "Override AI engine (copilot, claude, codex, gemini, antigravity, crush)")
	...
	runCmd.Flags().StringP("engine", "e", "", "Override AI engine (copilot, claude, codex, gemini, antigravity, crush)")
