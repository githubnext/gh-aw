...
| `antigravity-models` | Model inventory job | Download step | Antigravity model inventory data |
...
| `collect_gemini_models` | Model collection | Various | Collects Antigravity model inventory |
...
| `/tmp/gh-aw/antigravity-client-error-*.json` | Files | Antigravity error logs | Error details from Antigravity client execution |
...
| `/tmp/gh-aw/.antigravity/agents` | Directory | Antigravity custom agents | Custom agent definitions mounted for Antigravity engine |
...
| `/tmp/gh-aw/model-inventory/antigravity/` | Directory | Antigravity model data | Antigravity models inventory (models.json, raw.json) |
| `/tmp/gh-aw/model-inventory/antigravity/models.json` | File | Antigravity models JSON | Processed Antigravity models inventory |
| `/tmp/gh-aw/model-inventory/antigravity/raw.json` | File | Antigravity raw JSON | Raw Antigravity API model list |
...
const DefaultAntigravityVersion Version = "0.37.1"
...
const AntigravityLLMGatewayPort = 10003
```
...
| `parse_antigravity_log.cjs` | Parses Antigravity engine execution logs |
...
| `ANTIGRAVITY_API_KEY` | API key for Antigravity engine | Agent job (antigravity engine) |
| `ANTIGRAVITY_API_BASE_URL` | Custom base URL for Antigravity API | Agent job (antigravity engine) |
...
| `GH_AW_SUB_AGENT_DIR` | Subdirectory for custom agent definitions (relative to workspace) | Agent job (`.claude/agents`, `.codex/agents`, `.antigravity/agents`, `.github/agents`) |
...
├── .antigravity/agents/             # Antigravity custom agent definitions
...
│   ├── antigravity/                 # Antigravity models (models.json, raw.json)
