...
# Test Workflow`;
        ...
        const isWorkflowFile = (0, extension_1.isAgenticWorkflowFile)(workflowDocument);
        ...
        const isNotWorkflowFile = (0, extension_1.isAgenticWorkflowFile)(nonWorkflowDocument);
...
This is the markdown content section.`;
        ...
        try {
            ...
            const isInFM = (0, extension_1.isInFrontmatter)(document, frontmatterPosition);
            ...
            const isNotInFM = (0, extension_1.isInFrontmatter)(document, markdownPosition);
...
This is just regular markdown content without any frontmatter.`;
        ...
        try {
            const isWorkflowFile = (0, extension_1.isAgenticWorkflowFile)(document);
    ...
    test('Extension should handle empty files', async () => {
        ...
        try {
            const isWorkflowFile = (0, extension_1.isAgenticWorkflowFile)(emptyDocument);
...
//# sourceMappingURL=extension-functions.test.js.map