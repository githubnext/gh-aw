			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Security Checklist', link: '/guides/security-checklist/' },
						{ label: 'Prompt Injection Prevention', link: '/guides/prompt-injection/' },
						{ label: 'Supply Chain Security', link: '/guides/supply-chain-security/' },
