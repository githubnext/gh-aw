				...
				starlightBlog({
					authors: {
						'gh-next': {
							...
							picture: 'https://avatars.githubusercontent.com/githubnext',
						},
						'dsyme': {
							name: 'Don Syme',
							url: 'https://dsyme.net/',
							picture: 'https://avatars.githubusercontent.com/dsyme',
						},
						'peli': {
							name: 'Peli de Halleux',
							url: 'https://www.microsoft.com/research/people/jhalleux/',
							picture: 'https://avatars.githubusercontent.com/pelikhan',
						},
					},
				}),
