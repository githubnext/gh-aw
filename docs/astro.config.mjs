...
export default defineConfig({
  ...
  redirects: {
    ...
    "/guides/ai-issue-triage/": "/gh-aw/examples/ai-issue-triage/",
    "/guides/automated-pr-review/": "/gh-aw/examples/automated-pr-review/",
    "/guides/docs-automation/": "/gh-aw/examples/docs-automation/",
    "/guides/ai-release-notes/": "/gh-aw/examples/ai-release-notes/",
    "/use-cases/ai-issue-triage/": "/gh-aw/examples/ai-issue-triage/",
    "/use-cases/automated-pr-review/": "/gh-aw/examples/automated-pr-review/",
    "/use-cases/ai-release-notes/": "/gh-aw/examples/ai-release-notes/",
    "/use-cases/docs-automation/": "/gh-aw/examples/docs-automation/",
    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          label: "Examples",
          items: [
            { label: "AI Issue Triage", link: "/examples/ai-issue-triage/" },
            { label: "Automated PR Review", link: "/examples/automated-pr-review/" },
            { label: "Docs Automation", link: "/examples/docs-automation/" },
            { label: "AI Release Notes", link: "/examples/ai-release-notes/" },
