...
### Neutral
- The change is asserted to be behavior-preserving; correctness depends on existing compiler tests covering validation order, merge precedence, and formatted-error output.
...
*This is a DRAFT ADR generated by the [Design Decision Gate](https://github.com/github/gh-aw/actions/runs/26700056071) workflow. The PR author must review, complete, and finalize this document before the PR can merge.*
