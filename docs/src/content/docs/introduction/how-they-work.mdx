...
Workflows support **GitHub Copilot** (default), **Claude by Anthropic**, **Codex**, and **Antigravity by Google**. Each [engine](/gh-aw/reference/engines/) (AI model/provider) interprets natural language instructions and executes them using configured tools and permissions.
