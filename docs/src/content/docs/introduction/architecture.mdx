...
flowchart TB
    ...
    subgraph MCPLayer["MCP Server Layer"]
        ...
        subgraph GitHub["GitHub MCP"]
            GH_TOOLS["Enabled Tools:<br/>• get_issue<br/>• list_commits<br/>• search_code"]
...
All user-generated content is sanitized before being processed by AI agents, preventing prompt injection and other attacks.
...
flowchart LR
    ...
    subgraph Sanitization["Content Sanitization"]
        direction TB
...
| **Compilation** | Security scanners | Privilege escalation, misconfigurations |
