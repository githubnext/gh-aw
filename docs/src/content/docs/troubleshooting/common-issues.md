...
If you're using the legacy `allowed:` pattern, migrate to `toolsets:` for better maintainability. See [Migration from Allowed to Toolsets](/gh-aw/guides/mcps/#migration-from-allowed-to-toolsets).
:::
