...
a powerful workflow authoring tool. This guide shows how to use the create-agentic-workflow prompt to design workflows conversationally with AI.

## When to Use This Tool

Use the create-agentic-workflow prompt when:
- **Creating new workflows** - Design workflows conversationally rather than manually writing markdown
- **Learning the schema** - The prompt guides you through valid configuration options
- **Iterating on ideas** - Refine workflow logic through conversation

For quick starts with tested examples, use `gh aw add` instead. See [Quick Start Guide](/gh-aw/start-here/quick-start/).

## Prerequisites

Before using the create-agentic-workflow prompt, ensure you have:
- GitHub CLI extension installed (`gh extension install githubnext/gh-aw`)
- One of the following AI assistants:
  - GitHub Copilot Chat in VS Code (recommended)
  - GitHub Copilot CLI
  - Other AI chat tools (with manual file loading)
