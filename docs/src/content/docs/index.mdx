...
import { WORKSHOP_ORG_SLUG } from '../../lib/workshop/config';
...
<FeatureGrid columns={2}>
  <FeatureCard icon="workflow" title="Interactive workshop" href={`/gh-aw/workshops/${WORKSHOP_ORG_SLUG}/`} badge="New">
  ...
  <FeatureCard icon="mark-github" title="Source repository" href="https://github.com/githubnext/gh-aw-workshop">
    Browse the original gh-aw-workshop repository, source markdown, and workshop assets.
  </FeatureCard>
</FeatureGrid>
