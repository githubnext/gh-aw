...
Explore our comprehensive collection of agentic workflows organized into 4 main categories. Each category addresses different aspects of software development and team coordination through intelligent automation.
...
All sample workflows are part of the [Agentics collection](https://github.com/githubnext/agentics) - a comprehensive set of demonstrator agentic workflows that showcase the capabilities of GitHub Agentic Workflows for various automation scenarios.

> **⚠️ Research Demonstrator**: These are demonstrator workflows for experimental use. Review all outputs carefully and use time-limited trials to evaluate effectiveness for your team.
