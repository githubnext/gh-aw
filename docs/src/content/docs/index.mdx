...
hero:
  ...
  tagline: Intelligent automation for GitHub. Run the coding agents you know and love, with strong guardrails and cost controls, in GitHub Actions.
  actions:
...
GitHub Agentic Workflows is in Public Preview and may change significantly before general availability.
:::
