...
<FeatureGrid columns={3}>
  ...
  <FeatureCard icon="tools" title="Effective Token Budgets" href="/gh-aw/reference/frontmatter/#effective-token-budget-max-ai-credits">
    Cap runaway runs with max-ai-credits and optimize around effective-token usage
  </FeatureCard>
</FeatureGrid>
