...
<FeatureGrid columns={2}>
  <FeatureCard icon="issue-opened" title="AI Issue Triage" href="/gh-aw/use-cases/ai-issue-triage/">
    Label, deduplicate, and ask clarifying questions when new issues arrive
  </FeatureCard>
  <FeatureCard icon="code-review" title="Automated PR Review" href="/gh-aw/use-cases/automated-pr-review/">
    Review diffs and post feedback comments when pull requests are opened
  </FeatureCard>
  <FeatureCard icon="tag" title="AI Release Notes" href="/gh-aw/use-cases/ai-release-notes/">
    Generate release summaries and changelog drafts automatically
  </FeatureCard>
  <FeatureCard icon="book" title="Docs Automation" href="/gh-aw/use-cases/docs-automation/">
