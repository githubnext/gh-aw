...
Wake up to ready-to-review repository improvements — automated triage, CI insights, docs updates, and test enhancements.

GitHub Agentic Workflows deliver repository automation: simple markdown workflows running the coding agents you know and love, in GitHub Actions, with strong guardrails and security-first design principles.

Use event-triggered and scheduled jobs to augment your existing, deterministic CI/CD with AI-powered intelligence. Supported AI engines include GitHub Copilot, Claude Code, Google Gemini and OpenAI Codex.

Developed by GitHub and Microsoft, workflows run with strong guardrails, using safe outputs and sandboxed execution to help keep your repository safe.
...
<FeatureGrid columns={3}>
  ...
  <FeatureCard icon="server" title="GitHub Actions or Self-Hosted" href="/gh-aw/reference/self-hosted-runners/">
    Use GitHub Actions or self-hosted runners, including ARC with Docker-in-Docker
  </FeatureCard>
</FeatureGrid>
...
<FeatureGrid columns={3}>
  ...
  <FeatureCard icon="container" title="Sandbox & Firewall" href="/gh-aw/introduction/architecture/#agent-workflow-firewall-awf">
    The agent runs in a container with firewall;
...
<FeatureGrid columns={3}>
  ...
  <FeatureCard icon="book" title="Docs Automation" href="/gh-aw/examples/docs-automation/">
  ...
  <FeatureCard icon="issue-opened" title="AI Issue Triage" href="/gh-aw/examples/ai-issue-triage/">
    Label, deduplicate, and ask clarifying questions when new issues arrive
  </FeatureCard>
  <FeatureCard icon="code-review" title="Automated PR Review" href="/gh-aw/examples/automated-pr-review/">
    Review diffs and post feedback comments when pull requests are opened
  </FeatureCard>
  <FeatureCard icon="tag" title="AI Release Notes" href="/gh-aw/examples/ai-release-notes/">
