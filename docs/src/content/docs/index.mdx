...
hero:
  ...
  tagline: |
    ...
    <span class="hero-preview-callout">GitHub Agentic Workflows is in Public Preview and may change significantly.</span>
  actions:
...
:::tip[Learn with hands-on exercises]
The [**gh-aw-workshop**](https://github.com/githubnext/gh-aw-workshop) is a self-contained workshop repository designed to teach GitHub Agentic Workflows step by step. Fork it and follow along at your own pace.
:::
