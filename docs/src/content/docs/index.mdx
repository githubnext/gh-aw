...
<FeatureGrid columns={3}>
  ...
  <FeatureCard icon="server" title="Use at Scale" href="/gh-aw/guides/using-at-scale">
    Use at scale in you organization or enterprise across multiple repositores
  </FeatureCard>
</FeatureGrid>
...
<FeatureGrid columns={3}>
  <FeatureCard icon="issue-opened" title="Automated Repository Maintenance" href="https://github.com/githubnext/agentics/blob/main/docs/repo-assist.md">
    Use Repo Assist to automatically label issues, triage issues, fix backlogs and make focused project improvements
  </FeatureCard>
  <FeatureCard icon="book" title="Automated Docs" href="/gh-aw/examples/docs-automation/">
    Keep documentation in sync with code changes via automated PRs
  </FeatureCard>
  <FeatureCard icon="code-review" title="Continuous Improvement" href="/gh-aw/examples/code-improvement/">
    Daily code simplification, refactoring, and style improvements
  </FeatureCard>
  <FeatureCard icon="pulse" title="Metrics & Analytics" href="/gh-aw/examples/metrics-analytics/">
    Daily reports, trend analysis, and workflow health monitoring
  </FeatureCard>
  <FeatureCard icon="tools" title="Quality & Testing" href="/gh-aw/examples/ci-failure-investigation/">
