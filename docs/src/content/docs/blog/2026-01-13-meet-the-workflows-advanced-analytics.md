...
- **[Copilot Session Insights](https://github.com/githubnext/gh-aw/blob/v0.37.7/.github/workflows/copilot-session-insights.md?plain=1)** - Analyzes Copilot agent usage patterns and metrics  
- **[Copilot PR NLP Analysis](https://github.com/githubnext/gh-aw/blob/v0.37.7/.github/workflows/copilot-pr-nlp-analysis.md?plain=1)** - Natural language processing on PR conversations  
- **[Prompt Clustering Analysis](https://github.com/githubnext/gh-aw/blob/v0.37.7/.github/workflows/prompt-clustering-analysis.md?plain=1)** - Clusters and categorizes agent prompts using ML  
- **[Copilot Agent Analysis](https://github.com/githubnext/gh-aw/blob/v0.37.7/.github/workflows/copilot-agent-analysis.md?plain=1)** - Deep analysis of agent behavior patterns  
...
```bash
gh aw add https://github.com/githubnext/gh-aw/blob/v0.37.7/.github/workflows/copilot-pr-nlp-analysis
```

**Prompt Clustering Analysis:**

```bash
gh aw add https://github.com/githubnext/gh-aw/blob/v0.37.7/.github/workflows/prompt-clustering-analysis.md
```
