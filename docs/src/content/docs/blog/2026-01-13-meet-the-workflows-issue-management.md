...
- **[Issue Template Optimizer](https://github.com/github/gh-aw/blob/v0.45.5/.github/workflows/issue-template-optimizer.md?plain=1)** - Improves issue templates based on usage - **2 merged PRs out of 2 proposed (100% merge rate)**
...
```bash
gh aw add-wizard https://github.com/github/gh-aw/blob/v0.45.5/.github/workflows/issue-template-optimizer.md
```
