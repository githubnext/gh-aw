...
- **[Automatic Code Simplifier](https://github.com/githubnext/agentics/blob/main/.github/workflows/code-simplifier.md?plain=1)** - Analyzes recently modified code and creates PRs with simplifications  
- **[Duplicate Code Detector](https://github.com/githubnext/agentics/blob/main/.github/workflows/duplicate-code-detector.md?plain=1)** - Uses Serena's semantic analysis to identify duplicate code patterns  
...
```bash
gh aw add-wizard https://github.com/githubnext/agentics/blob/main/.github/workflows/code-simplifier.md
```

**Duplicate Code Detector:**

```bash
gh aw add-wizard https://github.com/githubnext/agentics/blob/main/.github/workflows/duplicate-code-detector.md
```
