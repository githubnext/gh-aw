...
Let's take a look at the full **[Issue Triage Agent](https://github.com/githubnext/agentics/blob/main/.github/workflows/issue-triage-agent.md?plain=1)**:
...
```bash
gh aw add-wizard https://github.com/githubnext/agentics/blob/main/.github/workflows/issue-triage-agent.md
```
