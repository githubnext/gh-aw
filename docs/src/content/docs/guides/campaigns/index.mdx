...
hero:
  title: Agentic Campaigns
  tagline: <strong>Coordinate AI agents across multiple workflow runs</strong> with structured, goal-driven initiatives tracked in GitHub Projects. Strategic automation for large-scale repository operations.
  actions:
    - text: Getting Started
      link: /gh-aw/guides/campaigns/getting-started/
      icon: right-arrow
      variant: primary
    - text: View Specs
      link: /gh-aw/guides/campaigns/specs/
      icon: external
      variant: minimal
---
