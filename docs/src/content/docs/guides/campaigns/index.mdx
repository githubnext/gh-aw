...
- **Track progress in one place** (a single [GitHub Project](/gh-aw/reference/glossary/#github-projects-projectsv2))
...
- **[Frontmatter](/gh-aw/reference/glossary/#frontmatter)**: the configuration ([GitHub Project URL](/gh-aw/reference/glossary/#github-projects-projectsv2), scope, worker list, governance limits)
