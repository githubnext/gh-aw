...
```md
Migrate all API endpoints to the new authentication system,
ensuring backward compatibility and updating documentation.
```

The campaign generator automatically converts this into a **[campaign spec](/gh-aw/guides/campaigns/specs/)** in a pull request where you can review and iterate on the details. Here's what the essential parts look like:

```yaml
---
id: api-auth-migration
name: "API Auth Migration"
description: "Migrate all endpoints to new authentication system"

# GitHub Project for tracking
project-url: "https://github.com/orgs/ORG/projects/1"
tracker-label: "campaign:api-auth-migration"

# Strategic goals
objective: "Migrate all API endpoints to the new auth system without breaking existing clients."
kpis:
  - id: endpoints_migrated
