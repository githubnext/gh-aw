...
Campaigns provide tracking infrastructure that coordinates work across repositories and teams. All campaign work is visible through GitHub Projects.

## Why use campaigns?

<FeatureGrid columns={2}>
  <FeatureCard icon="goal" title="Strategic Goals" href="/gh-aw/guides/campaigns/specs/#strategic-goals-objective--kpis">
    Define campaign objectives and key performance indicators (KPIs). Optional narrative context.
  </FeatureCard>
...
The campaign generator converts this into a **[campaign spec](/gh-aw/guides/campaigns/specs/)** in a pull request. Essential spec components:
