...
Use custom steps to precompute data, filter triggers, or prepare context for AI agents. See [Deterministic & Agentic Patterns](/gh-aw/patterns/deterministic-agentic-patterns/) for combining computation with AI reasoning.
...
The agentic execution job waits for all custom jobs to complete. Custom jobs can share data through artifacts or job outputs. See [Deterministic & Agentic Patterns](/gh-aw/patterns/deterministic-agentic-patterns/) for multi-job workflows.
