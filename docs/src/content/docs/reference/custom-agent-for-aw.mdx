---
title: Copilot Skills support for Agentic Workflows
...
## Installing the Copilot Skill Files for Agentic Workflows
...
2. **Install the Copilot Skill Files for Agentic Workflows into your repository**. 
...
After initialization, you'll have `.github/skills/agentic-workflows/SKILL.md`, a Copilot skill file that registers the `agentic-workflows` skill in Copilot Chat.

## Using the Copilot Skill Files for Agentic Workflows
