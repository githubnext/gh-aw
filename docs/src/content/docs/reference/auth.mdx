...
- **Alternative:** None
- **Notes:** API key for the Google Antigravity CLI
...
If using the Antigravity by Google engine, you need to set a GitHub Actions secret `ANTIGRAVITY_API_KEY` with an API key for the Antigravity CLI.
