...
This page describes authentication settings for GitHub Agentic Workflows (`gh-aw`). AI engine inference credentials are separate from credentials used for GitHub API operations, safe outputs, CI triggering, and Git commit attribution.
