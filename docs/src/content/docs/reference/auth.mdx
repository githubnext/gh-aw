...
Older gh-aw docs and workflows may still refer to Gemini. In current gh-aw releases, Gemini has been renamed to Antigravity — run `gh aw fix --write` and use `ANTIGRAVITY_API_KEY`.
