...
Apart from that, most workflows will run without any additional secrets or additional authentication. However, depending on your workflow, you may need additional GitHub tokens. These can be added as secrets and referenced in your workflow, or GitHub App authentication can be used as a more secure alternative.
