...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>github.run_id</code></td><td>Standardized GitHub run ID resource attribute.</td></tr>
    <tr><td><code>github.repository</code></td><td>Standardized GitHub repository resource attribute.</td></tr>
...
<table>
  ...
  <tbody>
    <tr><td><code>gen_ai.system</code></td><td>Standardized OpenTelemetry GenAI system name.</td></tr>
    ...
    <tr><td><code>gen_ai.usage.cost</code></td><td>Inference cost in USD; backend-consumable alias for <code>gh-aw.aic</code> (1 AIC = 0.01 USD).</td></tr>
  </tbody>
</table>
