...
Python 3.10+ is available with standard library modules. For third-party packages, use the `dependencies:` field so gh-aw installs them before first tool invocation.
