...
| [Pydantic AI](https://ai.pydantic.dev) (experimental) | `pydantic` | [COPILOT_GITHUB_TOKEN](/gh-aw/reference/auth/#copilot_github_token) (default); switches to provider-specific secret when `model:` uses `provider/model` format |
...
| Feature | Copilot | Claude | Codex | Gemini | Crush | OpenCode | Pi | Pydantic AI |
|---------|:-------:|:------:|:-----:|:------:|:-----:|:--------:|:--:|:-----------:|
