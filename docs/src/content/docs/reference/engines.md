...
description: Complete guide to AI engines (coding agents) usable with GitHub Agentic Workflows, including Copilot, Claude, Codex, Gemini, Crush, OpenCode, Pi, and Auggie with their specific configuration options.
sidebar:
  order: 600
---
...
| [Auggie](https://docs.augmentcode.com/cli/overview) (experimental) | `auggie` | [AUGMENT_SESSION_AUTH](/gh-aw/reference/auth/#augment_session_auth) session JSON produced by `auggie login` |
...
| Feature | Copilot | Claude | Codex | Gemini | Crush | OpenCode | Pi | Auggie |
|---------|:-------:|:------:|:-----:|:------:|:-----:|:--------:|:--:|:------:|
