...
safe-outputs:
  ...
  create-issue:
    ...
    # matching after normalization. Also accepts a GitHub Actions expression that
    # resolves to a boolean at runtime. Applies within-run and
    ...
    # Format 2: GitHub Actions expression
    deduplicate-by-title: ${{ inputs.enable-title-dedup }}
