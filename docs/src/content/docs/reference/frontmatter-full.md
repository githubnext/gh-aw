...
# githubnext/agentics/workflows/shared/common.md@v1.0.0). Files ending with
# '.agent.md' are treated as custom agent files (only one agent file allowed
# per workflow).
# (optional)
imports: []
  # Array of Workflow specification in format owner/repo/path@ref. Files with
  # '.agent.md' extension are treated as agent configuration files.
