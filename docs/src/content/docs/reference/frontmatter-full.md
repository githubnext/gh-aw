...
safe-outputs:
  ...
  # Enable managed comment memory persistence using marker-scoped comments and
  # editable local markdown files.
  # (optional)
  # This field supports multiple formats (oneOf):
  ...
  # Option 2: Enable (true) or disable (false) comment-memory. false explicitly opts
