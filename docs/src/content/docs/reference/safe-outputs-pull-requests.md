...
safe-outputs:
  create-pull-request:
    ...
    protected-files: fallback-to-issue  # push branch, create review issue if manifest files modified
```
...
safe-outputs:
  ...
  push-to-pull-request-branch:
    protected-files: fallback-to-issue  # create issue instead of pushing when manifests change
```
