...
description: Exploring AI-powered repository automation, run safely on GitHub
  Actions. From GitHub Next
template: splash
hero:
  tagline: Exploring AI-powered repository automation, run safely on GitHub
    Actions. From GitHub Next
  actions:
    - text: Quick Start Guide
      link: /gh-aw/0.27/start-here/quick-start/
      icon: right-arrow
    - text: View on GitHub
...
<CardGrid stagger>
  <Card title="Quick Start" icon="rocket">
    ...
    [Get Started →](/gh-aw/0.27/start-here/quick-start/)
  </Card>
  ...
  <Card title="Learn Concepts" icon="open-book">
    ...
    [Learn More →](/gh-aw/0.27/start-here/concepts/)
  </Card>
  ...
  <Card title="Browse Commands" icon="setting">
    ...
    [View Commands →](/gh-aw/0.27/tools/cli/)
  </Card>
  ...
  <Card title="Security Guide" icon="approve-check-circle">
    ...
    [Security Guide →](/gh-aw/0.27/guides/security/)
  </Card>
</CardGrid>
...
<CardGrid>
  <Card title="Automated Research, Status & Planning" icon="information">
    ...
    [Explore Research & Planning Workflows →](/gh-aw/0.27/samples/research-planning/)
  </Card>
  ...
  <Card title="Automated Triage & Analysis" icon="magnifier">
    ...
    [Explore Triage & Analysis Workflows →](/gh-aw/0.27/samples/triage-analysis/)
  </Card>
  ...
  <Card title="Semi-automatic Coding & Development" icon="setting">
    ...
    [Explore Coding & Development Workflows →](/gh-aw/0.27/samples/coding-development/)
  </Card>
  ...
  <Card title="Semi-automatic Quality & Testing" icon="star">
    ...
    [Explore Semi-automatic Quality & Testing Workflows →](/gh-aw/0.27/samples/quality-testing/)
  </Card>
</CardGrid>
