---
title: Common Issues
description: Frequently encountered issues when working with GitHub Agentic
  Workflows and their solutions.
sidebar:
  order: 200
slug: 0.27/troubleshooting/common-issues
---
...
2. **Incorrect tool names**
   ...
   * See [tools reference](/gh-aw/0.27/reference/tools/)
...
**Solution:** Use only [allowed expressions](/gh-aw/0.27/reference/templating/):
...
1. **Check documentation:** Review [reference docs](/gh-aw/0.27/reference/workflow-structure/) for detailed configuration options
...
* [Error Reference](/gh-aw/0.27/troubleshooting/errors/)
* [Validation Timing](/gh-aw/0.27/troubleshooting/validation-timing/)
* [Frontmatter Reference](/gh-aw/0.27/reference/frontmatter/)
