---
title: Using MCPs
description: Learn how to use Model Context Protocol (MCP) servers with GitHub
  Agentic Workflows to connect AI agents to external tools, databases, and
  services.
sidebar:
  order: 200
slug: 0.27/guides/mcps
---
...
GitHub Agentic Workflows includes built-in GitHub MCP integration with comprehensive repository access. See [Tools](/gh-aw/0.27/reference/tools/) for details.

:::tip[Use Toolsets for GitHub Tools]
Prefer using `toolset:` instead of `allowed:` for GitHub tools. Toolsets provide better organization and ensure complete functionality. See the [GitHub Toolsets](/gh-aw/0.27/reference/tools/#github-toolsets) section for details.
:::
...
* [Tools](/gh-aw/0.27/reference/tools/) - Complete tools reference
* [CLI Commands](/gh-aw/0.27/tools/cli/) - CLI commands including `mcp inspect`
* [Imports](/gh-aw/0.27/reference/imports/) - Modularizing workflows with includes
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - All configuration options
* [Workflow Structure](/gh-aw/0.27/reference/workflow-structure/) - Directory organization
