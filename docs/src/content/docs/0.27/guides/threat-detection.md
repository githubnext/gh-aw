...
description: Configure automated threat detection to analyze agent output and
  code changes for security issues before they are applied.
sidebar:
  order: 650
slug: 0.27/guides/threat-detection
---
...
* [Safe Outputs Reference](/gh-aw/0.27/reference/safe-outputs/) - Complete safe outputs configuration
* [Security Guide](/gh-aw/0.27/guides/security/) - Overall security best practices
* [Custom Safe Outputs](/gh-aw/0.27/guides/custom-safe-outputs/) - Creating custom output types
* [Frontmatter Reference](/gh-aw/0.27/reference/frontmatter/) - All configuration options
