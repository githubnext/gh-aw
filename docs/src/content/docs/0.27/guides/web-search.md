...
description: Learn how to add web search capabilities to GitHub Agentic
  Workflows using Tavily MCP server.
sidebar:
  order: 210
slug: 0.27/guides/web-search
---
...
* [MCP Integration](/gh-aw/0.27/guides/mcps/) - Complete MCP server guide
* [Tools](/gh-aw/0.27/reference/tools/) - Tool configuration reference
* [AI Engines](/gh-aw/0.27/reference/engines/) - Engine capabilities and limitations
