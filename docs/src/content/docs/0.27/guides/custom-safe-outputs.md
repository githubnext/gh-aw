...
description: Learn how to create custom safe outputs for third-party
  integrations using custom jobs and MCP servers.
sidebar:
  order: 700
slug: 0.27/guides/custom-safe-outputs
---
...
Every safe-job must define inputs using workflow\_dispatch syntax. The inputs become the MCP tool arguments:
...
* [Safe Outputs](/gh-aw/0.27/reference/safe-outputs/) - Built-in safe output types
