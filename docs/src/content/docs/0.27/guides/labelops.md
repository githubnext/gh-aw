---
title: LabelOps
description: Learn how to use GitHub labels as workflow triggers with AI-powered
  automation for intelligent issue and pull request management using label
  filtering.
slug: 0.27/guides/labelops
---
...
* [Trigger Events](/gh-aw/0.27/reference/triggers/) - Complete trigger configuration including label filtering
* [IssueOps Guide](/gh-aw/0.27/guides/issueops) - Learn about issue-triggered workflows
* [Safe Outputs Reference](/gh-aw/0.27/reference/safe-outputs) - Secure output handling
* [Frontmatter Reference](/gh-aw/0.27/reference/frontmatter) - Complete workflow configuration options
