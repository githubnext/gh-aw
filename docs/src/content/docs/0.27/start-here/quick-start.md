...
description: Get your first agentic workflow running in minutes. Install the
  extension, add a sample workflow, set up secrets, and run your first
  AI-powered automation.
sidebar:
  order: 200
slug: 0.27/start-here/quick-start
---
...
For Claude and Codex, see the instructions in [AI Engines](/gh-aw/0.27/reference/engines/).
...
* **Learn about adding and updating workflows** — Read [Packaging and Updating](/gh-aw/0.27/guides/packaging-imports/) to understand workflow management
* **Learn the concepts** — Read [Concepts](/gh-aw/0.27/start-here/concepts/) to understand how agentic workflows work
