...
sidebar:
  order: 100
slug: 0.27/samples/research-planning
---
...
Analyzes all MCP configuration files, extracts server details, and generates comprehensive inventory reports to maintain visibility into available MCP servers and their capabilities. Runs weekly on Mondays at 10am UTC, or manually via workflow\_dispatch. Workflow file: `.github/workflows/mcp-inspector.md`
