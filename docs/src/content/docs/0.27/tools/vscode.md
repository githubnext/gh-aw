...
description: Learn about the gh aw CLI tools for improving your developer
  experience in VS Code and other IDEs, including Copilot instructions.
sidebar:
  order: 300
slug: 0.27/tools/vscode
---
...
## /create-agentic-workflow command <a id="create-agentic-workflow" />
