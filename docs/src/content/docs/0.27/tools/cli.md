---
title: CLI Commands
description: Complete guide to all available CLI commands for managing agentic
  workflows with the GitHub CLI extension, including installation, compilation,
  and execution.
sidebar:
  order: 200
slug: 0.27/tools/cli
...
Trial results are saved to `trials/` directory and captured in the trial repository for inspection. Set `GH_AW_GITHUB_TOKEN` to override authentication. See the [Security Guide](/gh-aw/0.27/guides/security/#authorization-and-token-management).
...
Discover, list, inspect, and add Model Context Protocol (MCP) servers. See [MCPs Guide](/gh-aw/0.27/guides/mcps/) and [MCP Server Guide](/gh-aw/0.27/tools/mcp-server/).
...
Uses subprocess architecture for token isolation. Import with `shared/mcp/gh-aw.md` in workflows. See [MCP Server Guide](/gh-aw/0.27/tools/mcp-server/).

## 👀 Watch Mode for Development

Auto-recompile workflows on file changes. See [Authoring in VS Code](/gh-aw/0.27/tools/vscode/).
...
* [Packaging and Updating](/gh-aw/0.27/guides/packaging-imports/) - Complete guide to adding, updating, and importing workflows
* [Workflow Structure](/gh-aw/0.27/reference/workflow-structure/) - Directory layout and file organization
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - Configuration options for workflows
* [Safe Outputs](/gh-aw/0.27/reference/safe-outputs/) - Secure output processing including issue updates
* [Tools](/gh-aw/0.27/reference/tools/) - GitHub and MCP server configuration
