---
title: Imports
description: Learn how to modularize and reuse workflow components across
  multiple workflows using the imports field in frontmatter for better
  organization and maintainability.
sidebar:
  order: 325
slug: 0.27/reference/imports
---
...
Only one agent file can be imported per workflow. See [Custom Agent Files](/gh-aw/0.27/reference/engines/#custom-agent-files) for details on creating and using agent files.
...
* [Packaging and Updating](/gh-aw/0.27/guides/packaging-imports/) - Complete guide to managing workflow imports
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - Configuration options reference
* [MCPs](/gh-aw/0.27/guides/mcps/) - Model Context Protocol setup
