...
sidebar:
  order: 350
slug: 0.27/reference/templating
---
...
* [Imports](/gh-aw/0.27/reference/imports/) in frontmatter or markdown
...
**Pattern expressions**: `needs.*` (job outputs), `steps.*` (step outputs), and `github.event.inputs.*` (workflow\_dispatch inputs) are also permitted.
...
* [Markdown](/gh-aw/0.27/reference/markdown/) - Writing effective agentic markdown
* [Workflow Structure](/gh-aw/0.27/reference/workflow-structure/) - Overall workflow organization
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - YAML configuration
* [Imports](/gh-aw/0.27/reference/imports/) - Imports
