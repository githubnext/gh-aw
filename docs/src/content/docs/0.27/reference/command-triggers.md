...
description: Learn about command triggers and context text functionality for
  agentic workflows, including special @mention triggers for interactive
  automation.
sidebar:
  order: 500
slug: 0.27/reference/command-triggers
---
...
See [Reactions](/gh-aw/0.27/reference/frontmatter/) for available reactions and detailed behavior.
