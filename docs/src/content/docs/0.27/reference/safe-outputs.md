---
title: Safe Outputs
description: Learn about safe output processing features that enable creating
  GitHub issues, comments, and pull requests without giving workflows write
  permissions.
sidebar:
  order: 800
slug: 0.27/reference/safe-outputs
---
...
Custom safe output types can be defined through [Custom Safe Output Jobs](/gh-aw/0.27/guides/custom-safe-outputs/).
...
See [Custom Safe Output Jobs](/gh-aw/0.27/guides/custom-safe-outputs/) for detailed documentation.
...
You can specify the `runs-on` field in the `safe-outputs:` section to use a custom GitHub Actions runner image for all safe output jobs (including pre-activation, activation, and update\_reaction jobs). The default is `ubuntu-slim`, which provides a lightweight, cost-effective 1 vCPU Linux runner. See the [GitHub blog post](https://github.blog/changelog/2025-10-28-1-vcpu-linux-runner-now-available-in-github-actions-in-public-preview/) for details.
...
:::tip
See the [Threat Detection Guide](/gh-aw/0.27/guides/threat-detection/) for comprehensive documentation, examples, and best practices.
:::

## Related Documentation

* [Threat Detection Guide](/gh-aw/0.27/guides/threat-detection/) - Complete threat detection documentation and examples
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - All configuration options for workflows
* [Workflow Structure](/gh-aw/0.27/reference/workflow-structure/) - Directory layout and organization
* [Command Triggers](/gh-aw/0.27/reference/command-triggers/) - Special /my-bot triggers and context text
