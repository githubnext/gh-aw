...
description: Complete JSON Schema-based reference for all GitHub Agentic
  Workflows frontmatter configuration options with YAML examples.
sidebar:
  order: 201
slug: 0.27/reference/frontmatter-full
---
...
:::note
This documentation is automatically generated from the JSON Schema. For a more user-friendly guide, see [Frontmatter](/gh-aw/0.27/reference/frontmatter/).
:::
...
* See the [Frontmatter guide](/gh-aw/0.27/reference/frontmatter/) for detailed explanations and examples
* See individual reference pages for specific topics like [Triggers](/gh-aw/0.27/reference/triggers/), [Tools](/gh-aw/0.27/reference/tools/), and [Safe Outputs](/gh-aw/0.27/reference/safe-outputs/)
