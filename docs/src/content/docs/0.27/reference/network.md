...
description: Control network access for AI engines using ecosystem identifiers
  and domain allowlists
sidebar:
  order: 1300
slug: 0.27/reference/network
---
...
> **Note**: Network permissions are currently supported by the Claude engine and the Copilot engine (when using the [firewall feature](/gh-aw/0.27/reference/engines/#network-permissions)).
...
See the [Copilot Engine - Network Permissions](/gh-aw/0.27/reference/engines/#network-permissions) documentation for detailed AWF configuration options.
...
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - Complete frontmatter configuration guide
* [Tools](/gh-aw/0.27/reference/tools/) - Tool-specific network access configuration
* [Security Notes](/gh-aw/0.27/guides/security/) - Comprehensive security guidance
