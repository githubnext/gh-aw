---
title: Memory
description: Complete guide to using cache-memory for persistent file storage
  across workflow runs using GitHub Actions cache and simple file operations.
sidebar:
  order: 1500
slug: 0.27/reference/cache-memory
---
...
* [Safe Outputs](/gh-aw/0.27/reference/safe-outputs/) - Output processing and automation
