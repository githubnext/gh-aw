...
description: Complete guide to concurrency control in GitHub Agentic Workflows,
  including agent job concurrency configuration and engine isolation.
sidebar:
  order: 1400
slug: 0.27/reference/concurrency
---
...
* [AI Engines](/gh-aw/0.27/reference/engines/) - Engine configuration and capabilities
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - Complete frontmatter reference
