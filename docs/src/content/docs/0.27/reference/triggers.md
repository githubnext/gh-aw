...
The compiler uses repository ID comparison for reliable fork detection that is not affected by repository renames. See the [Security Guide](/gh-aw/0.27/guides/security/#fork-protection-for-pull-request-triggers) for detailed security implications.
...
See the [Security Guide](/gh-aw/0.27/guides/security/#workflow_run-trigger-security) for detailed security behavior and implementation.

### Command Triggers (`command:`)

The `command:` trigger creates workflows that respond to `/command-name` mentions in issues, pull requests, and comments. See [Command Triggers](/gh-aw/0.27/reference/command-triggers/) for complete documentation.
...
This filtering is especially useful for [LabelOps workflows](/gh-aw/0.27/guides/labelops/) where specific labels trigger different automation behaviors.
...
* [Command Triggers](/gh-aw/0.27/reference/command-triggers/) - Special @mention triggers and context text
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - Complete frontmatter configuration
* [LabelOps Guide](/gh-aw/0.27/guides/labelops/) - Label-based automation workflows
