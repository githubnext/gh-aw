...
Agentic markdown supports GitHub Actions expression substitutions and conditional templating for content. See [Templating and Substitutions](/gh-aw/0.27/reference/templating/) for details.

## Related Documentation

* [Workflow Structure](/gh-aw/0.27/reference/workflow-structure/) - Overall workflow file organization
* [Frontmatter](/gh-aw/0.27/reference/frontmatter/) - YAML configuration options
