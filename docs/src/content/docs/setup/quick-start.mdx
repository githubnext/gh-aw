...
> 1. Create an API key from [Anthropic Console](https://platform.claude.com/docs/en/get-started).
> 2. Add it as a repository secret from your repository root with `gh aw secrets set ANTHROPIC_API_KEY --value "<your-anthropic-api-key>"`, or use the GitHub UI. See [Authentication](/gh-aw/reference/auth/#anthropic_api_key) for more detail.
>
