...
2. Set **Resource owner** to your personal account (not an organization). This is required by the GitHub platform: `COPILOT_GITHUB_TOKEN` needs **Copilot Requests** user-level permission, which is only available for user accounts.
