...
<Tabs>
  ...
  <TabItem label="Pi">
    ...
    Pi also requires no special GitHub access configuration — it automatically derives CLI GitHub access. Follow [Using Pi with GitHub Agentic Workflows](/gh-aw/engines/pi/) for the complete setup.
  </TabItem>
</Tabs>
