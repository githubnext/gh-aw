...
**Setting up your API key?** Select the engine you chose above:
...
- [AI Issue Triage on GitHub](/gh-aw/use-cases/ai-issue-triage/) — label, deduplicate, and ask clarifying questions on new issues automatically
- [Automated AI Pull Request Review](/gh-aw/use-cases/automated-pr-review/) — review diffs and post feedback comments when PRs are opened
- [AI-Generated Release Notes and Reports](/gh-aw/use-cases/ai-release-notes/) — generate release summaries and repo reports on a schedule
- [Keeping Documentation Up to Date Automatically](/gh-aw/use-cases/docs-automation/) — propose documentation updates as pull requests when code changes
