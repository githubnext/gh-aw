...
4. **Add the workflow** - Adds the workflow file (`.md`) and its generated GitHub Actions [lock file](/gh-aw/reference/workflow-structure/#lock-file-header) to `.github/workflows/`.
...
- [AI Issue Triage on GitHub](/gh-aw/examples/ai-issue-triage/) — label, deduplicate, and ask clarifying questions on new issues automatically
- [Automated AI Pull Request Review](/gh-aw/examples/automated-pr-review/) — review diffs and post feedback comments when PRs are opened
- [AI-Generated Release Notes and Reports](/gh-aw/examples/ai-release-notes/) — generate release summaries and repo reports on a schedule
- [Keeping Documentation Up to Date Automatically](/gh-aw/examples/docs-automation/) — propose documentation updates as pull requests when code changes
