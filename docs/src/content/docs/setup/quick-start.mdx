...
- [Agent Factory blog series](https://github.github.com/gh-aw/blog/2026-01-12-welcome-to-pelis-agent-factory/) — a 19-part tour of real-world agentic workflows by the gh-aw maintainers, covering issue triage, releases, quality checks, and more.
