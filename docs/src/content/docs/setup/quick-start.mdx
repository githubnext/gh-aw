...
2. Set **Resource owner** to your personal account (not an organization). `COPILOT_GITHUB_TOKEN` requires **Copilot Requests** user-level permission, which is only available for user accounts.
