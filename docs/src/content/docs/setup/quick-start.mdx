...
- **AI Account** - [GitHub Copilot](https://github.com/features/copilot), [Anthropic Claude](https://www.anthropic.com/), [OpenAI Codex](https://openai.com/api/), or [Antigravity](https://ai.google.dev/antigravity-api)
...
> [!NOTE]
> If you're following older Gemini setup instructions, use Antigravity instead: `engine: antigravity` with `ANTIGRAVITY_API_KEY`.
