...
3. **Set up required authentication**.
   ...
   If you haven't done so already, [choose and authenticate an AI engine](/gh-aw/reference/engines/). Copilot is the default; set `engine:` in [frontmatter](/gh-aw/reference/frontmatter/) for Claude Code, OpenAI Codex, Google Gemini, or experimental Pi.
