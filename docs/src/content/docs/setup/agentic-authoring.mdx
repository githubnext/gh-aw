...
Go to https://github.com/copilot/agents, or Copilot Chat in VSCode, select your repository and use this prompt:
...
Go to https://github.com/copilot, or Copilot Chat in VSCode, select your repository and use this prompt:
