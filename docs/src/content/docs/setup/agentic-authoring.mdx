...
Go to https://github.com/copilot/agents, or another repository chat tool, select your repository and use this prompt:
...
Go to https://github.com/copilot, or another repository chat tool, select your repository and use this prompt:
