...
:::caution[File Location Requirements]
**All workflow files MUST be saved in the `.github/workflows/` directory.**
...
Files placed elsewhere will not be recognized by GitHub Actions.
:::
