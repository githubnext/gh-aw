...
const FS_SYNC_METHODS = new Set(["rmSync"]);
                  ...
                  fix(fixer) {
                    ...
                    return fixer.replaceText(
                      ...
                      buildTryCatchSuggestion(stmtText, {
                        indent,
                        todoComment: "TODO: handle filesystem failure for this fs.rmSync call.",
                        errorPrefix: "fs.rmSync failed: ",
                      })
                    );
                  },
                },
