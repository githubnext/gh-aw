...
.PHONY: deps-dev
deps-dev: deps copy-agents-to-claude download-github-actions-schema
...
# Copy agent instructions to Claude instructions file
.PHONY: copy-agents-to-claude
copy-agents-to-claude:
	@echo "Copying agent instructions to Claude instructions file..."
...
help:
	...
	@echo "  copy-agents-to-claude - Copy agent instructions to Claude instructions file"
