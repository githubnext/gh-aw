...
# Check that *_validation.go files stay within the 300-line hard limit (see AGENTS.md)
...
help:
	...
	@echo "  check-validator-sizes - Check *_validation.go files against the 300-line hard limit"
